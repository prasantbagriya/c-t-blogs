...
export default function Navbar() {
  ...
  const getHref = (page) => {
    ...
    if (page === 'auth') return getDevPath('/auth');
    if (page === 'about') return getDevPath('/about-us');
    if (page === 'contact') return getDevPath('/contact-us');
    if (page === 'privacy') return getDevPath('/privacy-policy');
    if (page === 'terms') return getDevPath('/terms-of-service');
