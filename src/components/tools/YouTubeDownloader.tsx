...
const YouTubeDownloader = () => {
 ...
 >
 <div className="inline-flex items-center gap-3 px-6 py-2 bg-sky-500/10 border border-sky-500/20 rounded-none text-[10px] font-black tracking-[0.4em] text-sky-400 mb-12 animate-float uppercase backdrop-blur-3xl">
 ...
 >
 {/* Glow effects */}
 <div className="absolute -inset-10 bg-amber-500/5 blur-[120px] rounded-none pointer-events-none group-hover:bg-amber-500/10 " />
 
 <div
 ref={searchContainerRef}
 onMouseMove={handleSearchMouseMove}
 className="search-glow-wrapper console-card relative rounded-none md:rounded-none p-4 md:p-8"
 >
 {/* Console Header */}
 ...
 {/* Input Matrix */}
 <div className="relative flex flex-col md:flex-row items-center gap-4 bg-black/40 p-2 md:p-3 rounded-none md:rounded-none border border-white/3">
 ...
 />
 {url && <button onClick={() => setUrl("")} className="p-2 hover:bg-white/5 rounded-none"><X size={16} className="text-slate-500" /></button>}
 </div>
 ...
 className={cn(
 "w-full md:w-auto px-6 md:px-12 py-4 md:py-6 rounded-none md:rounded-none btn-stellar flex items-center justify-center gap-4 hover:scale-105",
 (loading || !url) && "opacity-50 cursor-not-allowed grayscale"
 )}
 >
 {loading ? <Cpu className="" size={20} /> : <Zap size={20} className="fill-current" />}
 ...
 <div className="flex items-center gap-3 px-5 py-2 bg-sky-400/5 rounded-none border border-sky-400/10">
 ...
 {/* Thumbnail Core */}
 <div className="lg:col-span-12 relative rounded-none md:rounded-none overflow-hidden group border border-white/5 -3xl aspect-video md:aspect-21/9">
 <img src={info.thumbnail} className="w-full h-full object-cover " alt="Extracted media" />
 <div className="absolute inset-0 bg-linear-to-t from-black via-black/20 to-transparent" />
 <div className="extraction-scanline" />
 
 <div className="absolute top-4 md:top-8 left-4 md:left-8 flex items-center gap-2 md:gap-3 px-3 py-1.5 md:px-5 md:py-2 bg-black/80 backdrop-blur-2xl border border-white/10 rounded-none">
 ...
 <span className="px-2 md:px-3 py-1 bg-amber-500 text-black text-[8px] md:text-[10px] font-black uppercase rounded-none">4K Available</span>
 <span className="text-zinc-400 text-[10px] md:text-xs font-bold leading-relaxed">{info.duration} Extracted</span>
 </div>
 </div>
 <div className="flex flex-col items-end gap-2 shrink-0">
 <div className="flex -space-x-3">
 {[1,2,3].map(i => <div key={i} className="w-10 h-10 rounded-none border-2 border-black bg-zinc-800 flex items-center justify-center text-[10px] font-bold">U{i}</div>)}
 </div>
 ...
 {/* Video Tier */}
 <div className="console-card rounded-none p-8">
 ...
 className="group flex items-center justify-between p-5 bg-white/3 hover:bg-amber-500/10 border border-white/5 hover:border-amber-500/30 rounded-none "
 >
 ...
 <div className="w-10 h-10 rounded-none bg-white/5 group-hover:bg-sky-400 flex items-center justify-center ">
 ...
 {/* Audio Tier */}
 <div className="console-card rounded-none p-8 border-amber-500/5">
 <div className="flex items-center justify-between mb-8 pb-4 border-b border-white/5">
 <h3 className="flex items-center gap-3 text-lg font-black uppercase tracking-[0.15em]">
 ...
 key={i}
 onClick={() => handleDownload(fmt.id)}
 className="group flex items-center justify-between p-5 bg-white/3 hover:bg-orange-500/10 border border-white/5 hover:border-orange-500/30 rounded-none "
 >
 <div className="flex flex-col text-left">
 ...
 <div className="w-10 h-10 rounded-none bg-white/5 group-hover:bg-orange-500 flex items-center justify-center ">
 ...
 <button onClick={() => setInfo(null)} className="px-10 py-4 bg-white/5 border border-white/10 rounded-none font-black uppercase text-[10px] tracking-widest hover:bg-white/10 flex items-center gap-3">
 ...
 className="max-w-2xl mx-auto mt-12 p-6 bg-red-500/10 border border-red-500/30 rounded-none flex items-center gap-4 text-red-500"
 >
 <div className="w-12 h-12 rounded-none bg-red-500/20 flex items-center justify-center shrink-0">
 <X size={20} />
 </div>
 <div>
