...
export const ExternalApiNode = ({ data, isConnectable }: any) => {
 ...
 return (
 <div className="px-4 py-3 bg-white dark:bg-[#1a1a24] rounded-none border border-cyan-500/30 dark:border-cyan-500/50 min-w-[260px] -cyan-500/5">
 ...
 <div className="p-1 bg-cyan-50 text-cyan-600 rounded-none">
