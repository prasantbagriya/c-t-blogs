...
export const HandoffNode = ({ data, isConnectable }: any) => (
  <div className="px-4 py-3 bg-white dark:bg-[#1a1a24] rounded-lg border border-orange-500/30 dark:border-orange-500/50 min-w-[220px] shadow-lg shadow-orange-500/5">
    ...
    <div className="space-y-3">
      <div className="p-2 bg-orange-50/50 dark:bg-orange-500/5 rounded border border-orange-100/50 dark:border-orange-500/10">
      ...
      <div className="space-y-2">
        ...
        <select
          ...
          className="w-full text-[10px] p-2 bg-slate-50 dark:bg-[#0f0f13] border border-slate-100 dark:border-white/5 rounded-lg outline-none font-bold text-slate-700 dark:text-slate-200"
        >
