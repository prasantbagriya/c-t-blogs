...
export const WaitNode = ({ data, isConnectable }: any) => (
 <div className="px-4 py-3 bg-white dark:bg-[#1a1a24] rounded-none border border-slate-200 dark:border-white/5 min-w-[150px]">
 ...
 <div className="p-1 bg-slate-100 text-slate-600 rounded-none">
 ...
 <input
 type="number"
 className="w-12 text-[10px] p-2 bg-slate-50 dark:bg-[#0f0f13] border border-slate-100 dark:border-white/5 rounded-none outline-none dark:text-white font-medium"
