...
export const YouTubeNode = ({ data, isConnectable }: any) => {
 return (
 <div className="px-4 py-3 bg-white dark:bg-[#1a1a24] rounded-none border border-red-500/30 dark:border-red-500/50 min-w-[260px] -red-500/5">
 ...
 <div className="p-1 bg-red-50 text-red-600 rounded-none">
