...
export const CatalogNode = ({ data, isConnectable }: any) => (
 ...
 <div className="p-3 bg-slate-50 dark:bg-[#0f0f13] border border-slate-100 dark:border-white/5 rounded-none flex items-center justify-center text-[10px] text-slate-400 font-medium">
 FB_CATALOG_MAIN_01
 </div>
 </div>
