...
export const AskLocationNode = ({ data, isConnectable }: any) => (
 <div className="px-4 py-3 bg-white dark:bg-[#1a1a24] rounded-none border border-rose-500/30 dark:border-rose-500/50 min-w-[220px] -rose-500/5">
 ...
 <div className="p-1 bg-rose-50 text-rose-600 rounded-none">
 ...
 <textarea rows={2} value={data.message || 'Please share your location by tapping the 📎 attachment icon and selecting Location.'} onChange={(e) => data.onChange('message', e.target.value)} className="w-full text-[10px] p-2 bg-slate-50 dark:bg-[#0f0f13] border border-slate-100 dark:border-white/5 rounded-none outline-none resize-none font-medium text-slate-700 dark:text-slate-200" />
 </div>
 </div>
