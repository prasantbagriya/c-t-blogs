...
const InfoIcon = ({ text }: { text: string }) => (
 ...
 <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 hidden group-hover:block w-32 p-2 bg-slate-800 text-[7px] text-white rounded-none z-50 leading-tight">
 {text}
...
export const TriggerNode = ({ data, isConnectable }: any) => {
 ...
 return (
 <div className="px-4 py-3 bg-white dark:bg-[#1a1a24] rounded-none border border-slate-200 dark:border-white/5 min-w-[200px]">
 ...
 className="w-full text-[10px] p-2 bg-blue-50 dark:bg-[#1a1a24] border border-blue-100 dark:border-blue-500/20 rounded-none outline-none text-slate-900 dark:text-white cursor-pointer font-medium"
 >
 ...
 className="w-full text-[10px] p-2 bg-slate-50 dark:bg-[#0f0f13] border border-slate-100 dark:border-white/5 rounded-none outline-none dark:text-white cursor-pointer font-medium"
 >
 ...
 <div className="space-y-4 fade-in slide-in-from-top-1">
 ...
 className="w-full text-[9px] p-2 bg-slate-50 dark:bg-[#0f0f13] border border-slate-100 dark:border-white/5 rounded-none outline-none dark:text-white font-medium"
 >
 ...
 <button
 onClick={addKeyword}
 className="px-2 py-1 bg-blue-500/10 text-blue-500 rounded-none text-[8px] font-medium uppercase hover:bg-blue-500 hover:text-white "
 >
 + Add New Word
 </button>
 </div>
 ...
 className="flex-1 text-[10px] p-2 bg-slate-50 dark:bg-[#0f0f13] border border-slate-100 dark:border-white/5 rounded-none outline-none dark:text-white font-medium"
 />
 <button
 onClick={() => removeKeyword(idx)}
 className="p-1.5 text-slate-300 hover:text-rose-500 opacity-0 group-hover/item:opacity-100 "
 >
 <Trash2 size={10} />
 </button>
 </div>
 ...
 {keywords.length === 0 && (
 <div className="text-center py-4 border border-dashed border-slate-200 dark:border-white/5 rounded-none">
 ...
 <div className="p-2 bg-slate-50 dark:bg-[#0f0f13] border border-slate-100 dark:border-white/5 rounded-none flex items-center justify-between">
