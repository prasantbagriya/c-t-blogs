...
export const TemplateNode = ({ data, isConnectable }: any) => {
 ...
 className="p-1 bg-blue-50 dark:bg-blue-500/10 text-blue-600 rounded-none hover:bg-blue-100 "
 ...
 {data.templateName && (
 <div className="space-y-2 fade-in slide-in-from-top-1">
 ...
 className="flex-1 text-[9px] p-1.5 bg-slate-50 dark:bg-[#0f0f13] border border-slate-100 dark:border-white/5 rounded-none outline-none"
