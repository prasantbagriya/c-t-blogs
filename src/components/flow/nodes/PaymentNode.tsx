...
export const PaymentNode = ({ data, isConnectable }: any) => (
 <>
 <div className="px-4 py-3 bg-white dark:bg-[#1a1a24] rounded-none border border-blue-500/30 dark:border-blue-500/50 min-w-[220px] -blue-500/5">
 ...
 <div className="space-y-1 fade-in zoom-in-95 ">
 ...
 className="w-full text-[10px] p-2 bg-slate-50 dark:bg-[#0f0f13] border border-slate-100 dark:border-white/5 rounded-none outline-none font-mono"
 />
 </div>
 ) : (
 <div className="grid grid-cols-2 gap-2 fade-in zoom-in-95 ">
 <div className="space-y-1">
 ...
 className="w-full text-[10px] p-2 bg-slate-50 dark:bg-[#0f0f13] border border-slate-100 dark:border-white/5 rounded-none outline-none font-medium"
 />
 </div>
 ...
 <input
 placeholder="SKU/ID"
 className="flex-1 text-[9px] p-1.5 bg-slate-50 dark:bg-white/5 border border-slate-100 dark:border-white/5 rounded-none outline-none"
 value={m.key}
 onChange={(e) => {
 const meta = [...data.metadata];
