...
export const GoogleDriveNode = ({ data, isConnectable }: any) => {
 return (
 <div className="px-4 py-3 bg-white dark:bg-[#1a1a24] rounded-none border border-indigo-500/30 dark:border-indigo-500/50 min-w-[260px] -indigo-500/5">
 ...
 <div className="p-1 bg-indigo-50 text-indigo-600 rounded-none">
