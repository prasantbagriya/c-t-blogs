...
export const ListNode = ({ data, isConnectable }: any) => {
 ...
 <div className="p-1 bg-blue-50 text-blue-500 rounded-none">
 ...
 className="w-full text-[10px] p-2 bg-slate-50 dark:bg-[#0f0f13] border border-slate-100 dark:border-white/5 rounded-none outline-none dark:text-white font-medium resize-none"
 rows={2}
 value={data.message || ''}
 ...
 className="w-full text-[9px] p-1.5 bg-slate-50 dark:bg-[#0f0f13] border border-slate-200 dark:border-white/10 rounded-none outline-none dark:text-white font-medium"
 placeholder="Section title (e.g. Options)..."
 />
 </div>
 {section.rows.map((row: any, idx: number) => (
 <div key={row.id} className="relative group space-y-1 p-2 bg-slate-50 dark:bg-[#0f0f13] border border-slate-100 dark:border-white/5 rounded-none hover:border-blue-500/30">
 ...
 className="w-2.5 h-2.5 rounded-none border-slate-300 text-blue-500 cursor-pointer"
 ...
 <div className="pt-1.5 border-t border-blue-100 dark:border-blue-500/10 slide-in-from-top-1">
 <div className="flex items-center gap-2 p-1.5 bg-blue-50 dark:bg-blue-500/5 rounded-none border border-blue-200/50 dark:border-blue-500/20">
 ...
 className="flex-1 text-[8px] bg-slate-100 dark:bg-white/5 rounded-none px-1 py-1 outline-none font-bold text-blue-600 cursor-pointer"
 >
 ...
 className="flex-1 text-[8px] bg-blue-50 dark:bg-blue-900/20 rounded-none px-1 py-1 outline-none font-bold text-blue-600"
 >
 ...
 <span className="text-[6px] text-emerald-500 font-black uppercase">Payment Link will be generated auto</span>
 </div>
 )}
 </div>
 </div>
 ...
 {row.leadCapture && (
 <div className="flex items-center gap-2 pt-1.5 border-t border-slate-200 dark:border-white/5 fade-in zoom-in-95 ">
 ...
 className="w-12 text-[8px] bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-500/30 rounded-none px-1 outline-none font-bold text-blue-600 placeholder-slate-400"
 placeholder="Type..."
 />
 <button
 ...
 <button 
 onClick={addSection}
 className="w-full py-1.5 mt-2 text-[9px] font-medium text-slate-500 bg-slate-50 dark:bg-white/5 hover:bg-slate-100 dark:hover:bg-white/10 rounded-none "
 >
 + Add Section
 </button>
 </div>
