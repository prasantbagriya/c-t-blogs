...
const PaymentView = () => {
 ...
 className="max-w-md w-full bg-white dark:bg-slate-800 rounded-none p-10 text-center border border-white/5"
 >
 <div className="w-20 h-20 bg-emerald-500/10 rounded-none flex items-center justify-center mx-auto mb-8">
 ...
 className="w-full py-4 bg-emerald-500 text-white rounded-none font-bold hover:bg-emerald-600 -emerald-500/20"
 >
 DONE
 </button>
 </motion.div>
 ...
 <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-blue-500/10 blur-[120px] rounded-none" />
 <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-purple-500/10 blur-[120px] rounded-none" />
 </div>

 <motion.div 
 initial={{ opacity: 0, y: 20 }}
 animate={{ opacity: 1, y: 0 }}
 className="max-w-md w-full bg-white dark:bg-slate-900/50 backdrop-blur-2xl rounded-none overflow-hidden border border-white/5 relative z-10"
 >
 {/* Header */}
 ...
 <div className="w-14 h-14 bg-white/20 rounded-none backdrop-blur-md flex items-center justify-center mx-auto mb-4 border border-white/20">
 ...
 <div className="flex items-center gap-4 group">
 <div className="w-10 h-10 bg-blue-500/10 rounded-none flex items-center justify-center text-blue-500 ">
 ...
 animate={{ opacity: 1, scale: 1 }}
 className="mb-8 p-4 bg-rose-500/10 border border-rose-500/20 rounded-none flex items-start gap-3"
 >
 ...
 className={`w-full py-5 rounded-none font-black text-sm uppercase tracking-[0.1em] flex items-center justify-center gap-3 relative overflow-hidden group ${status === 'processing' ? 'bg-slate-100 text-slate-400 cursor-not-allowed' : 'bg-slate-900 dark:bg-blue-600 text-white hover:scale-[1.02] -blue-500/20' }`}
 >
 {status === 'processing' ? (
 <>
