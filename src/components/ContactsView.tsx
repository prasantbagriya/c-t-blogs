...
export const ContactsView = ({ user, showToast }: ContactsViewProps) => {
 ...
 <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white dark:bg-[#16161d] p-4 sm:p-6 rounded-none border border-slate-200 dark:border-white/5">
 <div>
 ...
 className="flex-1 sm:flex-none px-4 py-2 sm:px-6 sm:py-3 bg-white dark:bg-[#1a1a24] border border-slate-200 dark:border-white/5 rounded-none font-bold text-[11px] sm:text-sm hover:border-blue-500 flex items-center justify-center gap-2 text-slate-700 dark:text-slate-200"
 >
 {isImporting ? <RefreshCw className="w-4 h-4 " /> : <Upload className="w-4 h-4" />}
 Import CSV
 </button>
 <input type="file" ref={fileInputRef} onChange={handleFileUpload} accept=".csv" className="hidden" />
 <button 
 onClick={() => handleOpenModal()}
 className="flex-1 sm:flex-none px-4 py-2 sm:px-6 sm:py-3 bg-blue-600 text-white rounded-none font-bold text-[11px] sm:text-sm hover:bg-blue-700 flex items-center justify-center gap-2">
 ...
 className="w-full pl-12 pr-4 py-3 bg-slate-50 dark:bg-[#1a1a24] border border-slate-200 dark:border-white/5 rounded-none text-sm focus:border-blue-500 outline-none dark:text-white"
 />
 </div>
 </div>
 ...
 {isLoading ? (
 <tr><td colSpan={5} className="px-6 py-12 text-center text-slate-400"><RefreshCw className="w-6 h-6 mx-auto mb-2" /> Loading contacts...</td></tr>
 ...
 <tr key={contact.id} className="hover:bg-slate-50/50 dark:hover:bg-white/5 group">
 <td className="px-6 py-4">
 <div className="flex items-center gap-3">
 <div className="w-8 h-8 rounded-none bg-blue-100 dark:bg-blue-900/40 text-blue-600 flex items-center justify-center font-bold text-xs uppercase">
 ...
 <span key={tag} className="px-2 py-0.5 bg-slate-100 dark:bg-white/5 rounded-none text-[10px] font-bold text-slate-500 uppercase">{tag}</span>
 ))}
 </div>
 </td>
 ...
 className="p-2 hover:bg-slate-100 dark:hover:bg-white/5 rounded-none text-slate-400 hover:text-blue-500 "
 title="Edit Contact"
 >
 ...
 className="p-2 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-none text-slate-400 hover:text-red-500 "
 ...
 className="w-full bg-slate-50 dark:bg-[#1a1a24] border border-slate-200 dark:border-white/5 rounded-none py-2 px-3 text-sm focus:border-blue-500 outline-none text-slate-900 dark:text-white"
 ...
 className="px-4 py-2 font-semibold text-slate-600 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-white/10 rounded-none text-sm"
 >
 Cancel
 </button>
 <button 
 onClick={handleSaveContact}
 className="px-4 py-2 font-semibold bg-blue-600 hover:bg-blue-700 text-white rounded-none text-sm -blue-500/20"
 >
 Save Contact
 </button>
 </div>
