...
export const WhatsAppFlowFormBuilder = ({ user, selectedAccount, editingFlow, onBack, onSave }: WhatsAppFlowFormBuilderProps) => {
 ...
 return (
 <div className={cn(
 "flex flex-col bg-slate-50 dark:bg-[#0f0f13] overflow-hidden ",
 ...
 <button 
 onClick={onBack}
 className="p-2 hover:bg-slate-100 dark:hover:bg-white/5 rounded-none "
 >
 ...
 className="bg-transparent text-base md:text-lg font-semibold text-slate-900 dark:text-white outline-none border-b border-transparent focus:border-blue-500 truncate"
 />
 ...
 className="flex-shrink-0 flex items-center gap-2 px-4 py-2.5 bg-[#1a1a24] text-slate-200 border border-white/5 rounded-none text-xs font-medium hover:bg-[#252533] "
 >
 <FileCode size={14} />
 ...
 className="flex-shrink-0 flex items-center gap-2 px-4 py-2.5 bg-[#1a1a24] text-slate-200 border border-white/5 rounded-none text-xs font-medium hover:bg-[#252533] disabled:opacity-50"
 >
 {isSaving ? <Plus size={14} className="" /> : <Save size={14} />}
 ...
 className={cn(
 "flex-shrink-0 p-2.5 rounded-none border border-white/5 hidden md:flex",
 ...
 className={cn("w-8 h-4 rounded-none relative ", autoTicket ? "bg-emerald-600" : "bg-slate-300 dark:bg-white/10")}
 >
 <div className={cn("absolute top-1 w-2 h-2 bg-white rounded-none ", autoTicket ? "right-1" : "left-1")} />
 </button>
 </div>
 ...
 disabled={isSaving || isSubmitting}
 className="flex-shrink-0 flex items-center gap-2 px-4 md:px-6 py-2.5 bg-blue-600 text-white rounded-none text-xs font-medium hover:bg-blue-700 -blue-600/20 disabled:opacity-50"
 >
 {isSubmitting ? <Plus size={14} className="" /> : <Play size={14} />}
 Submit
 </button>
 </div>
 </div>
 ...
 className={cn(
 "flex-1 py-2 rounded-none text-xs font-medium ",
 activeTab === 'edit' ? "bg-blue-600 text-white " : "bg-[#1a1a24] text-slate-400 border border-white/5"
 )}
 >
 Edit Flow
 </button>
 ...
 className={cn(
 "flex-1 py-2 rounded-none text-xs font-medium ",
 activeTab === 'preview' ? "bg-blue-600 text-white " : "bg-[#1a1a24] text-slate-400 border border-white/5"
 )}
 >
 Mobile Preview
 </button>
 ...
 className="w-full flex items-center justify-between text-[10px] font-semibold text-slate-400 mb-2 py-2 hover:text-slate-300 "
 >
 ...
 className="flex flex-col md:flex-row items-center gap-2 md:gap-3 p-2.5 md:p-3 bg-slate-50 dark:bg-[#1a1a24] border border-slate-200 dark:border-white/5 rounded-none hover:bg-slate-100 dark:hover:bg-[#252533] group text-center md:text-left"
 >
 <div className="w-8 h-8 shrink-0 rounded-none bg-white dark:bg-[#13131a] flex items-center justify-center text-slate-500 dark:text-slate-400 group-hover:text-blue-500 border border-slate-200 dark:border-white/5 ">
 {el.icon}
 </div>
 ...
 className="flex-1 flex items-center justify-between text-[10px] font-semibold text-slate-400 py-2 hover:text-slate-300 "
 >
 <div className="flex items-center gap-2">
 ...
 className="p-1 hover:bg-slate-100 dark:hover:bg-white/5 rounded-none text-blue-500"
 >
 <Plus size={16} />
 </button>
 <button 
 ...
 className="p-1 hover:bg-slate-100 dark:hover:bg-white/5 rounded-none text-emerald-500"
 >
 ...
 className={cn(
 "w-full flex items-center gap-3 p-3 rounded-none group",
 activeScreenId === screen.id 
 ? "bg-blue-600 text-white -blue-600/20" 
 ...
 <X 
 size={14} 
 className={cn("opacity-0 group-hover:opacity-100 ", activeScreenId === screen.id ? "hover:text-blue-200" : "hover:text-rose-500")}
 ...
 <div className={cn(
 "flex-1 flex flex-col overflow-y-auto p-0.5 bg-slate-50 dark:bg-[#0f0f13] custom-scrollbar z-10 ",
 ...
 >
 <div className="flex-1 bg-[#1e1e2d] rounded-none border border-white/5 font-mono text-[11px] md:text-xs text-blue-300 overflow-hidden flex flex-col">
 ...
 <button onClick={() => setIsFullscreenJson(!isFullscreenJson)} className="text-slate-400 hover:text-white flex items-center gap-1" title="Toggle Fullscreen">
 ...
 >
 <div className="bg-white dark:bg-[#13131a] p-2 md:p-4 rounded-none border border-slate-200 dark:border-white/5 ">
 ...
 className="text-lg md:text-xl font-bold bg-transparent outline-none border-b border-transparent focus:border-blue-500 w-full dark:text-white"
 ...
 <div key={field.id} className="bg-white dark:bg-[#13131a] p-2 md:p-4 rounded-none border border-slate-200 dark:border-white/5 group relative">
 ...
 className="font-semibold text-sm bg-transparent outline-none border-b border-transparent focus:border-blue-500 dark:text-white w-full"
 />
 </div>
 ...
 className="text-[10px] font-mono bg-slate-100 dark:bg-white/5 px-2 py-1 rounded-none w-full outline-none text-slate-500"
 ...
 className={cn("w-8 h-4 rounded-none relative ", field.required ? "bg-blue-600" : "bg-slate-200 dark:bg-slate-800")}
 >
 <div className={cn("absolute top-1 w-2 h-2 bg-white rounded-none ", field.required ? "right-1" : "left-1")} />
 </button>
 </div>
 )}
 <button 
 onClick={() => removeField(field.id)}
 className="p-2 text-slate-300 hover:text-rose-500 hover:bg-rose-50 dark:hover:bg-rose-500/10 rounded-none "
 >
 <Trash2 size={16} />
 </button>
 </div>
 ...
 className="w-full p-2 bg-slate-50 dark:bg-[#0f0f13] border border-slate-100 dark:border-white/5 rounded-none text-xs outline-none focus:border-blue-500/50 dark:text-white "
 />
 )}
 ...
 className="w-full h-24 p-2 bg-slate-50 dark:bg-[#0f0f13] border border-slate-100 dark:border-white/5 rounded-none text-xs outline-none focus:border-blue-500/50 dark:text-white resize-none"
 />
 )}
 ...
 className="px-3 py-2 border border-dashed border-blue-500/30 text-blue-500 rounded-none text-[11px] font-semibold hover:bg-blue-50 dark:hover:bg-blue-500/10 "
 >
 + Add Option
 </button>
 </div>
 ...
 <div className="bg-white dark:bg-[#13131a] p-6 rounded-none border border-slate-200 dark:border-white/5 space-y-4">
 ...
 className="w-full h-32 p-4 bg-slate-50 dark:bg-[#0f0f13] border border-slate-100 dark:border-white/5 rounded-none text-sm outline-none focus:border-blue-500/50 dark:text-white resize-none"
 ...
 <button 
 onClick={() => addScreen('form')}
 className="flex-1 py-4 border-2 border-dashed border-slate-200 dark:border-white/5 rounded-none text-slate-400 hover:text-blue-500 hover:border-blue-500/50 hover:bg-blue-50/10 font-semibold text-xs flex items-center justify-center gap-2"
 >
 <Plus size={16} />
 Add Form Screen
 </button>
 <button 
 onClick={() => addScreen('success')}
 className="flex-1 py-4 border-2 border-dashed border-slate-200 dark:border-white/5 rounded-none text-slate-400 hover:text-emerald-500 hover:border-emerald-500/50 hover:bg-emerald-50/10 font-semibold text-xs flex items-center justify-center gap-2"
 >
 <CheckCircle2 size={16} />
 Add Success Screen
 </button>
 ...
 exit={{ opacity: 0, x: 20 }}
 className={cn(
 "w-full md:w-[360px] bg-white dark:bg-[#13131a] border-l border-slate-200 dark:border-white/5 flex flex-col items-center justify-start px-0.5 py-2 md:px-1 md:py-4 overflow-y-auto custom-scrollbar absolute inset-0 md:relative z-30 md:translate-x-0",
 ...
 <div className="w-full max-w-[280px] bg-[#e5ddd5] dark:bg-[#0b141a] rounded-none p-0 border-[8px] border-slate-900 dark:border-[#202c33] h-fit min-h-[500px] flex flex-col relative scale-[1.18] origin-top mb-2">
 {/* Phone Notch */}
 <div className="absolute top-0 left-1/2 -translate-x-1/2 w-24 h-6 bg-slate-900 dark:bg-[#202c33] rounded-none z-20 flex items-center justify-center">
 <div className="w-8 h-1 bg-slate-800 rounded-none"></div>
 </div>
 
 {/* WhatsApp Header */}
 <div className="bg-[#075e54] dark:bg-[#202c33] px-3 py-2 flex items-center gap-2 mt-4 relative z-10 ">
 <div className="w-6 h-6 rounded-none bg-slate-200 flex items-center justify-center text-[8px] font-bold uppercase text-slate-600">
 ...
 <div className="bg-white dark:bg-[#202c33] rounded-none border border-slate-100 dark:border-white/5 p-2 max-w-[95%] relative fade-in slide-in-from-left-2 ">
 <div className="space-y-2">
 ...
 {f.type === 'image' && (
 <div className="w-full aspect-video bg-slate-100 dark:bg-[#13131a] rounded-none overflow-hidden mb-2">
 {f.url ? (
 ...
 {f.type === 'video' && (
 <div className="w-full aspect-video bg-slate-900 rounded-none overflow-hidden mb-2 flex items-center justify-center text-white/50 relative">
 <Play size={24} />
 <div className="absolute bottom-2 left-2 px-1 bg-black/50 rounded-none text-[7px]">0:45</div>
 </div>
 )}
 {f.type === 'document' && (
 <div className="w-full p-3 bg-slate-50 dark:bg-[#13131a] border border-slate-100 dark:border-white/5 rounded-none flex items-center gap-3 mb-2">
 <div className="w-8 h-8 bg-rose-100 text-rose-500 rounded-none flex items-center justify-center">
 <FileText size={16} />
 </div>
 ...
 <div className="w-3 h-3 rounded-none border border-slate-200 dark:border-white/10 shrink-0" />
 ...
 <div className="w-10 h-10 bg-emerald-100 dark:bg-emerald-500/20 text-emerald-600 rounded-none flex items-center justify-center mx-auto">
 ...
 <button className="w-full py-2 bg-[#00a884] text-white rounded-none font-bold text-[9px] flex items-center justify-center gap-2 ">
 ...
 <div className="w-12 h-1 bg-slate-800 rounded-none" />
 </div>
 </div>
 </motion.div>
 )}
