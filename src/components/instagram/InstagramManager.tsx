...
export const InstagramManager = ({
 ...
 <div className="w-20 h-20 bg-black dark:bg-white rounded-none flex items-center justify-center mb-8 ">
 ...
 <button onClick={handleSync} disabled={syncing} className="p-2.5 bg-slate-100 dark:bg-white/5 rounded-none text-slate-400 hover:text-black dark:hover:text-white ">
 <RefreshCw size={16} className={syncing ? '' : ''} />
 </button>
 </div>

 {/* Profile Summary Row */}
 <div className="px-3">
 <div className="bg-white dark:bg-[#16161d] p-6 rounded-none border border-slate-100 dark:border-white/5 flex items-center gap-6">
 <div className="relative">
 {selectedAccount?.profilePicture ? (
 <img src={selectedAccount.profilePicture} className="w-16 h-16 rounded-none object-cover border-4 border-slate-50 dark:border-white/5 " alt="" />
 ) : (
 <div className="w-16 h-16 rounded-none bg-black dark:bg-white flex items-center justify-center text-white dark:text-black "><Instagram size={24} /></div>
 )}
 <div className="absolute -bottom-1 -right-1 w-5 h-5 bg-emerald-500 rounded-none border-2 border-white dark:border-[#16161d]" />
 </div>
 <div>
 ...
 className="bg-white dark:bg-[#16161d] border border-slate-100 dark:border-white/5 p-5 rounded-none flex flex-col gap-4 text-left hover:border-black dark:hover:border-white group "
 >
 <div className="flex items-center justify-between">
 <div className={cn("w-10 h-10 rounded-none flex items-center justify-center text-white ", node.color)}>
 {React.cloneElement(node.icon as React.ReactElement, { size: 20 })}
 </div>
 <ChevronRight size={14} className="text-slate-300 group-hover:text-black dark:group-hover:text-white " />
 </div>
 <div>
 ...
 <button onClick={handleBack} className="p-2 hover:bg-slate-100 dark:hover:bg-white/5 rounded-none text-slate-400 hover:text-black dark:hover:text-white">
 <ArrowLeft size={20} />
 </button>
 <div>
