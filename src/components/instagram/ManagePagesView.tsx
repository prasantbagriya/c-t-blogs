...
export function ManagePagesView({
 ...
 <div className="w-20 h-20 bg-[#1877F2] rounded-none flex items-center justify-center mb-8 -blue-600/30">
 ...
 disabled={loading}
 className="px-8 py-4 bg-[#1877F2] text-white rounded-none font-black text-xs uppercase tracking-[0.2em] hover:bg-blue-700 flex items-center gap-3 -blue-600/30 disabled:opacity-60"
 >
 {loading ? <RefreshCw size={16} className="" /> : <Facebook size={16} />}
 Connect Now
 </button>
 ...
 className="w-10 h-10 flex items-center justify-center bg-slate-50 dark:bg-white/5 rounded-none hover:bg-slate-100 dark:hover:bg-white/10 text-slate-500 hover:text-black dark:hover:text-white"
 >
 <ChevronLeft size={20} />
 </button>
 <div>
 ...
 onClick={fetchPages} 
 disabled={loading} 
 className="p-2.5 bg-slate-50 dark:bg-white/5 rounded-none text-slate-400 hover:text-black dark:hover:text-white border border-slate-200/50 dark:border-white/5"
 >
 ...
 className={cn(
 "flex items-center gap-3 px-4 py-3 rounded-none border shrink-0",
 selectedPage?.id === page.id
 ? "bg-white dark:bg-[#151518] border-blue-500/30 text-slate-900 dark:text-white -blue-500/5 ring-1 ring-blue-500/10"
 ...
 className={cn("w-8 h-8 rounded-none object-cover grayscale-[0.5]", selectedPage?.id === page.id && "grayscale-0")} 
 alt="" 
 />
 {selectedPage?.id === page.id && (
 <div className="absolute -top-1 -right-1 w-3 h-3 bg-blue-500 rounded-none border-2 border-white dark:border-[#151518]" />
 )}
 </div>
 ...
 <button
 onClick={handleLinkFacebook}
 className="flex items-center gap-2 px-4 py-3 bg-[#1877F2]/10 text-[#1877F2] rounded-none border border-[#1877F2]/20 hover:bg-[#1877F2]/20 shrink-0"
 >
 <Plus size={16} />
 ...
 {/* ── Profile Hero Card ── */}
 <section>
 <div className="relative overflow-hidden bg-white dark:bg-[#111114] p-8 rounded-none border border-slate-200/60 dark:border-white/5 -slate-200/50 dark: group">
 ...
 <div className="relative">
 <div className="w-24 h-24 rounded-none bg-gradient-to-tr from-blue-600 to-indigo-400 p-1 ">
 {selectedPage.picture?.data?.url ? (
 <img
 src={selectedPage.picture.data.url}
 className="w-full h-full rounded-none object-cover border-4 border-white dark:border-[#111114]"
 alt={selectedPage.name}
 />
 ) : (
 <div className="w-full h-full rounded-none bg-blue-600 flex items-center justify-center border-4 border-white dark:border-[#111114]">
 <Facebook size={32} className="text-white" />
 </div>
 )}
 </div>
 <div className="absolute -bottom-2 -right-2 w-10 h-10 bg-white dark:bg-[#16161d] rounded-none flex items-center justify-center border border-slate-100 dark:border-white/5">
 ...
 <div className="px-2.5 py-1 bg-emerald-500/10 text-emerald-500 rounded-none flex items-center gap-1.5 border border-emerald-500/20">
 <ShieldCheck size={12} />
 ...
 <div className="flex items-center gap-2 px-4 py-2 bg-slate-50 dark:bg-white/5 rounded-none border border-slate-100 dark:border-white/5">
 ...
 <div className="flex items-center gap-2 px-4 py-2 bg-rose-500/10 rounded-none border border-rose-500/20">
 ...
 <button 
 onClick={fetchPages}
 className="px-6 py-3 bg-[#1877F2] text-white rounded-none font-black text-[10px] uppercase tracking-widest hover:bg-blue-700 -blue-500/20"
 >
 Refresh Data
 </button>
 </div>
 ...
 className="group bg-white dark:bg-[#111114] border border-slate-200/60 dark:border-white/5 p-6 rounded-none flex flex-col gap-5 text-left hover:border-blue-500/40 hover: "
 >
 <div className="flex items-center justify-between">
 <div className={cn("w-14 h-14 rounded-none flex items-center justify-center text-white ", feat.color)}>
 {React.cloneElement(feat.icon as React.ReactElement, { size: 24 })}
 </div>
 <div className="w-10 h-10 rounded-none flex items-center justify-center bg-slate-50 dark:bg-white/5 group-hover:bg-blue-500/10 ">
 ...
 <div 
 key={page.id} 
 className="flex items-center justify-between p-5 bg-white dark:bg-[#111114] rounded-none border border-slate-200/60 dark:border-white/5 hover:border-blue-500/20 group"
 >
 <div className="flex items-center gap-4">
 <div className="w-12 h-12 rounded-none overflow-hidden bg-slate-100 dark:bg-white/5">
 ...
 className="w-10 h-10 flex items-center justify-center bg-[#1877F2]/10 text-[#1877F2] rounded-none hover:bg-[#1877F2] hover:text-white disabled:opacity-50"
 >
 {connecting === page.id ? <RefreshCw size={16} className="" /> : <Plus size={18} />}
 </button>
 </div>
 ))}
 </div>
 ...
 <div className="w-24 h-24 bg-blue-500/10 rounded-none flex items-center justify-center mx-auto mb-8">
