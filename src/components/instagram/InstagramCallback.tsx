  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-[#0a0a0f] p-6">
      <div className="max-w-md w-full bg-white dark:bg-[#16161d] rounded-[2.5rem] p-10 border border-slate-200 dark:border-white/5 shadow-2xl text-center">
        <div className="w-20 h-20 bg-gradient-to-tr from-[#f9ce34] via-[#ee2a7b] to-[#6228d7] rounded-3xl flex items-center justify-center mx-auto mb-8 shadow-xl">
        ...
        {status === 'error' && (
          <div className="space-y-4">
            ...
            <button 
              ...
              className="mt-6 px-8 py-3 bg-black text-white rounded-2xl text-[10px] font-black uppercase tracking-widest shadow-lg shadow-black/20"
            >
