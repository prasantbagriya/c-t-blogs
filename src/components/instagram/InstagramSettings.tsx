...
export const InstagramSettings = ({ user, account, onAccountUpdate }: { user: any; account: any; onAccountUpdate?: (acc: any) => void }) => {
 ...
 {/* Profile Card */}
 <div className="bg-white dark:bg-[#16161d] border border-slate-200 dark:border-white/5 rounded-none p-5 sm:p-6 ">
 <div className="flex flex-col sm:flex-row items-center sm:items-start justify-between gap-6 mb-6">
 <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 text-center sm:text-left">
 {profile?.profilePicture ? (
 <img src={profile.profilePicture} className="w-16 h-16 rounded-none object-cover border-2 border-slate-900 dark:border-white " alt="" />
 ) : (
 <div className="w-16 h-16 rounded-none bg-black dark:bg-white flex items-center justify-center text-white dark:text-black text-2xl font-black ">
 ...
 className="w-full sm:w-auto flex items-center justify-center gap-2 px-6 py-3 bg-black dark:bg-white text-white dark:text-black rounded-none text-[10px] font-black uppercase tracking-widest hover:opacity-90 disabled:opacity-50 ">
 <RefreshCw size={12} className={loading ? '' : ''} />
 Sync Profile
 </button>
 </div>
 ...
 <div key={item.label} className="bg-slate-50 dark:bg-black/20 p-3 rounded-none border border-slate-100 dark:border-white/5">
 ...
 {/* Token Info */}
 <div className="bg-white dark:bg-[#16161d] border border-slate-200 dark:border-white/5 rounded-none p-6 ">
 ...
 <div className="flex items-center gap-3 p-4 bg-emerald-50 dark:bg-emerald-900/10 border border-emerald-200 dark:border-emerald-500/20 rounded-none">
 ...
 <div className="bg-white dark:bg-[#16161d] border border-red-500/20 rounded-none p-6 ">
 ...
 className="flex items-center gap-2 px-6 py-3 bg-red-600 text-white rounded-none text-[10px] font-black uppercase tracking-widest hover:opacity-90 disabled:opacity-50 -red-500/20">
 <Unlink size={14} />
