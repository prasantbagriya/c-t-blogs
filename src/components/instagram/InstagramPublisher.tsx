...
export const InstagramPublisher = ({ user, account }: { user: any, account: any }) => {
 ...
 <div className="bg-white dark:bg-[#16161d] rounded-none border border-slate-200 dark:border-white/5 p-5 sm:p-6 ">
 ...
 className={`flex-1 py-2.5 rounded-none border text-[10px] font-black uppercase tracking-widest ${ type === t ? 'bg-black dark:bg-white text-white dark:text-black border-black dark:border-white' : 'bg-slate-50 dark:bg-white/5 border-slate-100 dark:border-white/5 text-slate-400 hover:border-pink-500' }`}
 >
 {t}
 </button>
 ))}
 ...
 className="relative rounded-none overflow-hidden border border-slate-200 dark:border-white/10 aspect-square bg-black"
 >
 {isVideo ? (
 <video
 src={mediaPreviewUrl}
 ...
 <button
 onClick={clearMedia}
 className="absolute top-3 right-3 w-8 h-8 bg-black/60 hover:bg-black/80 rounded-none flex items-center justify-center text-white "
 >
 <X size={14} />
 </button>
 <div className="absolute bottom-3 left-3 px-2 py-1 bg-black/60 rounded-none text-white text-[9px] font-bold uppercase">
 ...
 className="p-10 border-2 border-dashed border-slate-200 dark:border-white/10 rounded-none flex flex-col items-center justify-center bg-slate-50/50 dark:bg-white/5 hover:bg-slate-50 dark:hover:bg-white/10 hover:border-emerald-400 dark:hover:border-emerald-500/50 cursor-pointer group"
 >
 <div className="w-14 h-14 bg-white dark:bg-[#1a1a24] rounded-none flex items-center justify-center mb-4 border border-slate-100 dark:border-white/5 ">
 {type === 'reel' ? (
 ...
 rows={4}
 className="w-full p-4 bg-slate-50 dark:bg-white/5 border border-slate-100 dark:border-white/10 rounded-none text-xs focus:ring-2 focus:ring-emerald-500 outline-none dark:text-white resize-none placeholder:text-slate-400"
 />
 ...
 {/* AI Rewrite */}
 <div className="flex items-center justify-between p-4 bg-emerald-50 dark:bg-emerald-900/10 rounded-none border border-emerald-100 dark:border-emerald-500/20">
 <div className="flex items-center gap-3">
 <div className="w-8 h-8 bg-emerald-500 text-white rounded-none flex items-center justify-center shrink-0">
 <Sparkles size={14} />
 </div>
 <div>
 ...
 className="px-3 py-1.5 bg-emerald-500 text-white rounded-none text-[9px] font-bold uppercase hover:opacity-90 disabled:opacity-50 flex items-center gap-1.5"
 >
 {isRewriting ? <Loader size={10} className="" /> : <Sparkles size={10} />}
 ...
 exit={{ opacity: 0 }}
 className={`mt-4 p-4 rounded-none flex items-start gap-3 text-xs font-medium ${ publishStatus === 'success' ? 'bg-emerald-50 dark:bg-emerald-900/10 text-emerald-700 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-500/20' : 'bg-rose-50 dark:bg-rose-900/10 text-rose-700 dark:text-rose-400 border border-rose-200 dark:border-rose-500/20' }`}
 >
 ...
 className="w-full mt-6 py-4 bg-black dark:bg-white text-white dark:text-black rounded-none font-black text-[10px] uppercase tracking-[0.2em] hover:opacity-90 disabled:opacity-40 disabled:cursor-not-allowed flex items-center justify-center gap-3 "
 >
 {isPublishing ? (
 <>
 ...
 <div className="bg-white dark:bg-[#16161d] rounded-none border border-slate-200 dark:border-white/5 p-5 ">
 ...
 <div className="w-10 h-10 bg-gradient-to-tr from-pink-500 to-yellow-500 rounded-none flex items-center justify-center overflow-hidden ">
 ...
 {mediaPreviewUrl && (
 <div className="mt-3 rounded-none overflow-hidden border border-slate-100 dark:border-white/5 bg-slate-50 dark:bg-black/20 aspect-square">
 {isVideo ? (
