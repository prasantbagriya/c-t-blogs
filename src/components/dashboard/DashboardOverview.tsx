    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        {stats.map((stat, i) => (
          <div
            key={i}
            className="bg-white dark:bg-[#16161d] border border-slate-200 dark:border-white/5 p-4 rounded-lg flex flex-col gap-3"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
        <div className="lg:col-span-8 bg-white dark:bg-[#16161d] border border-slate-200 dark:border-white/5 p-4 rounded-lg">
        ...
        <div className="lg:col-span-4 bg-white dark:bg-[#16161d] border border-slate-200 dark:border-white/5 p-4 rounded-lg">
      ...
      <div className="bg-slate-900 dark:bg-blue-900 p-8 rounded-lg flex flex-col md:flex-row items-center justify-between gap-6">
         <div>
         ...
         <button 
           ...
           className="px-6 py-3 bg-emerald-500 hover:bg-emerald-600 text-white font-bold rounded transition-colors whitespace-nowrap"
         >
            Create Broadcast
         </button>
      </div>
