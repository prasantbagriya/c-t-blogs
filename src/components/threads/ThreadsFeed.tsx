...
export const ThreadsFeed = ({ user, account, isMini = false }: { user: any, account: any, isMini?: boolean }) => {
 ...
 <div className="w-1 h-4 bg-black dark:bg-white rounded-none" />
 <h2 className="text-[10px] font-black uppercase tracking-widest text-slate-500">Recent Threads</h2>
 </div>
 <button 
 onClick={fetchFeed}
 disabled={loading}
 className="p-2 bg-white dark:bg-[#16161d] border border-slate-200 dark:border-white/5 rounded-none text-slate-500 hover:text-black dark:hover:text-white "
 >
 ...
 <RefreshCw className=" text-slate-300 mb-4" size={32} />
 <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Fetching Feed...</p>
 </div>
 ) : threads.length === 0 ? (
 <div className="text-center py-20 bg-white dark:bg-[#16161d] rounded-none border border-slate-200 dark:border-white/5 mx-1">
 ...
 "bg-white dark:bg-[#16161d] rounded-none border border-slate-200 dark:border-white/5 p-4 hover:border-blue-500/50 group ",
 isMini && "p-3 border-none bg-slate-50/50 dark:bg-white/5"
 )}>
 <div className="flex gap-3">
 <div className="shrink-0">
 <div className="w-10 h-10 bg-slate-100 dark:bg-white/5 rounded-none border border-slate-100 dark:border-white/5 flex items-center justify-center text-slate-500 text-xs font-black overflow-hidden">
 ...
 >
 {deletingId === thread.id ? <Loader2 size={12} className="" /> : <Trash2 size={12} />}
 </button>
 <a href={thread.permalink} target="_blank" rel="noreferrer" className="p-1.5 text-slate-300 hover:text-blue-500 hover:bg-blue-500/10 rounded-none ">
 ...
 <div key={child.id} className="shrink-0 w-[240px] rounded-none overflow-hidden border border-slate-100 dark:border-white/5 bg-slate-50 dark:bg-black/20">
 ...
 <div className="mb-3 rounded-none overflow-hidden border border-slate-100 dark:border-white/5 bg-slate-50 dark:bg-black/20">
 ...
 <a href={thread.permalink} target="_blank" rel="noreferrer" className="flex items-center gap-1.5 hover:text-rose-500 group/btn">
 <Heart size={14} className="text-rose-500 fill-rose-500/10 group-hover/btn:fill-rose-500 " />
 ...
 className={cn("flex items-center gap-1.5 group/btn", activeComments[thread.id] ? "text-blue-500" : "hover:text-blue-500")}
 >
 ...
 <a href={thread.permalink} target="_blank" rel="noreferrer" className="flex items-center gap-1.5 hover:text-emerald-500 group/btn">
 ...
 <div className="flex items-center gap-1.5 hover:text-blue-500 group/btn">
 ...
 className="ml-auto p-1.5 hover:bg-slate-100 dark:hover:bg-white/10 rounded-none text-slate-400 hover:text-black dark:hover:text-white"
 ...
 {loadingComments[thread.id] && <Loader2 size={12} className=" text-blue-500" />}
 </div>
 ...
 <div className="p-3 bg-slate-50 dark:bg-white/5 rounded-none border border-slate-100 dark:border-white/5">
 ...
 className="flex-1 h-9 bg-white dark:bg-white/5 border border-slate-100 dark:border-white/10 rounded-none px-3 text-[11px] outline-none text-slate-900 dark:text-white focus:border-blue-500 "
 onKeyDown={(e) => {
 ...
 className="h-9 px-3 bg-black dark:bg-white text-white dark:text-black rounded-none font-black text-[10px] uppercase tracking-widest hover:opacity-90 "
 >
 Send
 </button>
 </div>
 ...
 className="px-8 py-3 bg-white dark:bg-[#16161d] border border-slate-200 dark:border-white/10 rounded-none text-[10px] font-black uppercase tracking-[0.2em] text-slate-900 dark:text-white hover:bg-slate-50 dark:hover:bg-white/5 flex items-center gap-3 disabled:opacity-50"
 >
 {loadingMore ? <Loader2 size={14} className="" /> : <RefreshCw size={14} />}
