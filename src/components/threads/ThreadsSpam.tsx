...
export const ThreadsSpam = ({ user, account }: { user: any; account: any }) => {
 ...
 <div className="w-9 h-9 bg-rose-500/10 text-rose-500 rounded-none flex items-center justify-center ">
 <ShieldAlert size={18} />
 </div>
 <div>
 ...
 className={`flex-none px-3 md:px-4 py-2 md:py-1.5 rounded-none text-[9px] font-black uppercase tracking-widest ${!selectedThread && !searchThreads ? 'bg-black text-white dark:bg-white dark:text-black ' : 'bg-slate-100 dark:bg-white/5 text-slate-400'}`}
 >
 All
 </button>
 ...
 className="w-full h-9 md:h-8 pl-8 pr-3 bg-slate-50 dark:bg-white/5 border border-slate-100 dark:border-white/10 rounded-none text-[10px] md:text-[9px] font-bold outline-none text-slate-900 dark:text-white focus:border-blue-500 "
 />
 ...
 >
 <p className="text-[11px] md:text-[10px] font-black text-slate-900 dark:text-white uppercase group-hover:text-blue-500 ">Post ID: {t.id}</p>
 ...
 .map((item) => (
 <div key={item.id} className={`bg-white dark:bg-[#16161d] p-5 rounded-none border group ${selectedComments.includes(item.id) ? 'border-rose-500 ring-1 ring-rose-500/20' : 'border-slate-200 dark:border-white/5 hover:border-rose-500/30'}`}>
 ...
 className="px-4 py-2 bg-slate-100 dark:bg-white/5 text-slate-600 dark:text-slate-300 rounded-none text-[9px] font-black uppercase tracking-widest hover:bg-slate-200 dark:hover:bg-white/10 "
 >
 Ignore
 </button>
 <button 
 ...
 className="px-4 py-2 bg-rose-500 text-white rounded-none text-[9px] font-black uppercase tracking-widest hover:bg-rose-600 flex items-center gap-2"
 >
