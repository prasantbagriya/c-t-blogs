      ...
      <div className="mx-auto space-y-3">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-5 gap-3">
          {[
            ...
            <div key={idx} className="bg-white dark:bg-[#16161d] p-4 sm:p-6 rounded-xl border border-slate-200 dark:border-white/5 shadow-sm">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-3">
          <div className="lg:col-span-2 bg-white dark:bg-[#16161d] p-5 sm:p-8 rounded-xl border border-slate-200 dark:border-white/5 shadow-sm">
          ...
          <div className="bg-black dark:bg-[#16161d] text-white p-8 rounded-xl shadow-xl flex flex-col justify-between border border-white/5 relative overflow-hidden group">
            <div className="absolute top-0 right-0 w-32 h-32 bg-white/5 rounded-bl-full -mr-16 -mt-16 group-hover:scale-110 transition-transform" />
            ...
            <div className="pt-8 border-t border-white/10 mt-8 relative z-10">
               <div className="flex items-center justify-between text-[9px] font-black uppercase tracking-widest opacity-60 mb-3">
                  <span>Momentum</span>
                  <span className="flex items-center gap-1"><div className="w-1.5 h-1.5 bg-emerald-500 rounded-full" /> Live</span>
               </div>
               ...
               <button 
                onClick={fetchStats}
                disabled={loading}
                className="w-full mt-6 py-3 bg-white text-black rounded-lg font-black text-[10px] uppercase tracking-widest hover:bg-blue-500 hover:text-white transition-all shadow-xl disabled:opacity-50"
               >
                 {loading ? <RefreshCw size={14} className="animate-spin inline mr-2" /> : null}
