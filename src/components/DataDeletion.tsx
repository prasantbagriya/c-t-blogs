...
export const DataDeletion: React.FC<DataDeletionProps> = ({ onBack }) => {
 ...
 <button 
 onClick={onBack}
 className="flex items-center gap-2 text-slate-500 hover:text-blue-600 mb-8 font-bold text-sm"
 >
 <ArrowLeft size={18} /> Back to Home
 </button>

 <div className="bg-white dark:bg-slate-900 rounded-none p-6 md:p-10 border border-slate-200 dark:border-slate-200">
 <div className="flex items-center gap-4 mb-10">
 <div className="w-12 h-12 bg-rose-600 rounded-none flex items-center justify-center text-white">
 <Trash2 size={24} />
 </div>
 <div>
 ...
 <div className="p-6 bg-slate-50 dark:bg-slate-800 rounded-none border border-slate-100 dark:border-slate-200">
 ...
 <div className="w-6 h-6 rounded-none bg-slate-900 dark:bg-slate-800 text-white flex items-center justify-center flex-shrink-0 text-[10px] font-bold">1</div>
 <div>
 ...
 <div className="flex gap-4">
 <div className="w-6 h-6 rounded-none bg-slate-900 dark:bg-slate-800 text-white flex items-center justify-center flex-shrink-0 text-[10px] font-bold">2</div>
 <div>
 ...
 <div className="bg-slate-900 dark:bg-slate-800 rounded-none p-8 text-center text-white">
 ...
 <a href="mailto:support@chatwiz.com" className="inline-block px-8 py-3 bg-blue-600 text-white rounded-none font-bold text-[10px] uppercase tracking-widest hover:bg-white hover:text-blue-600 ">
 support@chatwiz.com
 </a>
 </div>
 </div>
