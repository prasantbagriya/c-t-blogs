...
export function WidgetConfigView({ user, showToast, onNavigate }: { user: any; showToast: any; onNavigate?: (tab: string, payload?: any) => void }) {
 ...
 <div className="w-12 h-12 border-4 border-indigo-600/20 border-t-indigo-600 rounded-none " />
 </div>
 );
 ...
 className={`w-full sm:w-auto px-2 sm:px-4 py-2.5 rounded-none font-bold flex items-center justify-center gap-1.5 sm:gap-2 whitespace-nowrap text-[12px] sm:text-sm ${ showMobilePreview ? 'bg-indigo-600 hover:bg-indigo-700 text-white' : 'bg-indigo-50 dark:bg-indigo-500/10 hover:bg-indigo-100 dark:hover:bg-indigo-500/20 text-indigo-600 dark:text-indigo-400' }`}
 >
 ...
 className="w-full sm:w-auto px-2 sm:px-4 py-2.5 bg-slate-100 dark:bg-white/5 hover:bg-slate-200 dark:hover:bg-white/10 text-slate-900 dark:text-white rounded-none font-bold flex items-center justify-center gap-1.5 sm:gap-2 whitespace-nowrap text-[12px] sm:text-sm"
 >
 ...
 className="w-full sm:w-auto px-2 sm:px-4 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-none font-bold flex items-center justify-center gap-1.5 sm:gap-2 whitespace-nowrap text-[12px] sm:text-sm"
 >
 ...
 className={`w-full flex-shrink-0 p-3 rounded-none text-left flex items-center gap-3 border ${ selectedWidget?.id === w.id ? 'bg-slate-50 dark:bg-white/5 border-indigo-500 ' : 'bg-transparent border-slate-200 dark:border-white/5 md:border-transparent hover:bg-slate-50 dark:hover:bg-white/5' }`}
 >
 <div className={`w-10 h-10 rounded-none flex items-center justify-center text-white font-bold flex-shrink-0 ${ selectedWidget?.id === w.id ? 'bg-indigo-600' : 'bg-slate-400 dark:bg-slate-700' }`}>
 ...
 className="p-2 text-slate-400 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-500/10 rounded-none opacity-0 group-hover:opacity-100"
 >
 ...
 {widgets.length === 0 && (
 <div className="p-4 text-center text-slate-500 text-sm border-2 border-dashed border-slate-200 dark:border-white/5 rounded-none">
 ...
 {/* General Settings */}
 <section className="bg-white dark:bg-[#16161d] p-3 rounded-none border border-slate-200 dark:border-white/5 space-y-4">
 <div className="flex items-center justify-between mb-2">
 <div className="flex items-center gap-3">
 <div className="w-10 h-10 bg-slate-100 dark:bg-white/5 text-slate-600 dark:text-slate-300 flex items-center justify-center rounded-none">
 ...
 className="px-3 py-1.5 bg-indigo-50 dark:bg-indigo-500/10 hover:bg-indigo-100 dark:hover:bg-indigo-500/20 text-indigo-600 dark:text-indigo-400 rounded-none text-xs font-bold flex items-center gap-1.5 "
 >
 ...
 className="w-full px-3 py-2.5 bg-slate-50 dark:bg-[#0f0f13] border border-slate-200 dark:border-white/5 rounded-none outline-none focus:border-indigo-500 text-slate-900 dark:text-white text-sm "
 />
 </div>
 <div className="space-y-1.5">
 ...
 className="w-full px-3 py-2.5 bg-slate-50 dark:bg-[#0f0f13] border border-slate-200 dark:border-white/5 rounded-none outline-none focus:border-indigo-500 text-slate-900 dark:text-white text-sm resize-none custom-scrollbar"
 />
 </div>
 </section>
 ...
 className="w-full px-3 py-2.5 bg-slate-50 dark:bg-[#0f0f13] border border-slate-200 dark:border-white/5 rounded-none outline-none focus:border-indigo-500 text-slate-900 dark:text-white text-sm cursor-pointer"
 >
 ...
 <div className="relative w-10 h-10 rounded-none overflow-hidden border border-slate-200 dark:border-white/5 flex-shrink-0">
 <input
 type="color"
 ...
 value={selectedWidget.primaryColor}
 onChange={e => setSelectedWidget({ ...selectedWidget, primaryColor: e.target.value })}
 className="flex-1 px-3 py-2.5 bg-slate-50 dark:bg-[#0f0f13] border border-slate-200 dark:border-white/5 rounded-none outline-none focus:border-indigo-500 text-slate-900 dark:text-white text-sm uppercase font-mono"
 />
 </div>
 </div>
 <div className="space-y-1.5">
 ...
 className="flex-1 h-1.5 bg-slate-200 dark:bg-white/10 rounded-none appearance-none cursor-pointer accent-indigo-600"
 />
 ...
 <pre className="p-4 bg-slate-50 dark:bg-[#0f0f13] border border-slate-200 dark:border-white/5 text-slate-600 dark:text-slate-300 rounded-none overflow-x-auto text-[13px] font-mono leading-relaxed custom-scrollbar">
 {getEmbedCode(selectedWidget.id)}
 </pre>
 <button
 onClick={() => copyToClipboard(getEmbedCode(selectedWidget.id!), selectedWidget.id!)}
 className="absolute top-2 right-2 px-3 py-1.5 bg-white dark:bg-[#16161d] border border-slate-200 dark:border-white/10 hover:bg-slate-50 dark:hover:bg-white/5 text-slate-700 dark:text-white rounded-none text-xs font-bold flex items-center gap-1.5 "
 >
 ...
 <div className="p-4 bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/5 rounded-none text-slate-500 text-sm flex items-center gap-3">
 ...
 <section className="bg-white dark:bg-[#16161d] p-6 rounded-none border border-slate-200 dark:border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4">
 ...
 className="w-full sm:w-auto px-5 py-2.5 text-red-500 hover:bg-red-50 dark:hover:bg-red-500/10 rounded-none font-bold flex items-center justify-center gap-2 text-xs border border-transparent hover:border-red-200 dark:hover:border-red-500/20"
 >
 <Trash2 className="w-4 h-4" />
 Delete Widget
 </button>
 ...
 onClick={handleSave}
 disabled={isSaving}
 className="w-full sm:w-auto px-8 py-2.5 bg-indigo-600 hover:bg-indigo-700 disabled:opacity-50 text-white rounded-none font-bold flex items-center justify-center gap-2 text-sm -indigo-500/20"
 >
 ...
 <div className={` ${showMobilePreview ? 'fixed inset-0 z-[100] bg-[#f8fafc] dark:bg-[#0a0a0f] p-4 flex flex-col xl:relative xl:inset-auto xl:z-10 xl:flex xl:p-6' : 'hidden'} ${previewSize === 'sm' ? 'xl:w-[350px]' : previewSize === 'lg' ? 'xl:w-[500px]' : 'xl:w-[400px]'} border-t xl:border-t-0 xl:border-l border-slate-200 dark:border-white/5 bg-slate-50/50 dark:bg-[#0a0a0f]`}
 >
 <div className="flex flex-col gap-3 mb-4">
 <div className="flex items-center justify-between">
 <h4 className="font-bold text-slate-900 dark:text-white">Live Preview</h4>
 <div className="flex items-center gap-2">
 <div className="hidden xl:flex bg-white dark:bg-[#16161d] p-1 rounded-none border border-slate-200 dark:border-white/5 ">
 <button onClick={() => setPreviewSize('sm')} className={`px-2.5 py-1 text-[10px] rounded-none uppercase tracking-wider font-bold ${previewSize === 'sm' ? 'bg-slate-100 dark:bg-white/10 text-slate-900 dark:text-white' : 'text-slate-400 hover:text-slate-600 dark:hover:text-slate-300'}`}>S</button>
 <button onClick={() => setPreviewSize('md')} className={`px-2.5 py-1 text-[10px] rounded-none uppercase tracking-wider font-bold ${previewSize === 'md' ? 'bg-slate-100 dark:bg-white/10 text-slate-900 dark:text-white' : 'text-slate-400 hover:text-slate-600 dark:hover:text-slate-300'}`}>M</button>
 <button onClick={() => setPreviewSize('lg')} className={`px-2.5 py-1 text-[10px] rounded-none uppercase tracking-wider font-bold ${previewSize === 'lg' ? 'bg-slate-100 dark:bg-white/10 text-slate-900 dark:text-white' : 'text-slate-400 hover:text-slate-600 dark:hover:text-slate-300'}`}>L</button>
 </div>
 {showMobilePreview && (
 <button 
 onClick={() => setShowMobilePreview(false)}
 className="w-8 h-8 flex items-center justify-center bg-white dark:bg-[#16161d] border border-slate-200 dark:border-white/5 rounded-none text-slate-500 hover:text-slate-900 dark:hover:text-white "
 >
 ...
 <div className="hidden xl:flex bg-white dark:bg-[#16161d] p-1 rounded-none border border-slate-200 dark:border-white/5 self-end">
 <button
 onClick={() => setViewMode('desktop')}
 className={`p-1.5 rounded-none ${viewMode === 'desktop' ? 'bg-slate-100 dark:bg-white/10 text-slate-900 dark:text-white ' : 'text-slate-400 hover:text-slate-600 dark:hover:text-slate-300'}`}
 >
 <Monitor className="w-4 h-4" />
 </button>
 <button
 onClick={() => setViewMode('mobile')}
 className={`p-1.5 rounded-none ${viewMode === 'mobile' ? 'bg-slate-100 dark:bg-white/10 text-slate-900 dark:text-white ' : 'text-slate-400 hover:text-slate-600 dark:hover:text-slate-300'}`}
 >
 ...
 <div className={`flex-1 relative ${viewMode === 'mobile' ? 'mx-auto max-w-[320px] w-full aspect-[9/18] rounded-none border-[6px] border-slate-800 ' : 'w-full bg-white dark:bg-slate-900 rounded-none border border-slate-200 dark:border-white/5'} flex flex-col overflow-hidden `}>
 {viewMode === 'desktop' && (
 ...
 <div className="w-3/4 h-6 bg-slate-100 dark:bg-[#16161d] rounded-none mb-3" />
 <div className="w-1/2 h-3 bg-slate-100 dark:bg-[#16161d] rounded-none mb-6" />
 <div className="space-y-2">
 <div className="w-full h-24 bg-slate-50 dark:bg-[#16161d] rounded-none" />
 <div className="w-full h-24 bg-slate-50 dark:bg-[#16161d] rounded-none" />
 </div>
 ...
 className="w-64 bg-white dark:bg-[#16161d] rounded-none border border-slate-200 dark:border-white/5 overflow-hidden flex flex-col"
 >
 <div 
 ...
 >
 <div className="w-8 h-8 rounded-none bg-white/20 flex items-center justify-center font-bold text-sm">
 ...
 <span className="w-1.5 h-1.5 rounded-none bg-emerald-400" /> Online
 </div>
 </div>
 </div>
 
 <div className="p-3 flex-1 bg-slate-50 dark:bg-[#0f0f13] space-y-3 h-48 overflow-y-auto">
 <div className="bg-white dark:bg-[#16161d] border border-slate-100 dark:border-white/5 text-slate-800 dark:text-slate-200 p-2.5 rounded-none text-xs max-w-[85%]">
 ...
 <div className="flex-1 h-8 bg-slate-50 dark:bg-[#0f0f13] border border-slate-200 dark:border-white/5 rounded-none flex items-center px-2">
 ...
 <div 
 className={`rounded-none flex items-center justify-center hover:scale-110 cursor-pointer ${selectedWidget.position === 'bottom-left' ? 'self-start' : 'self-end'}`}
 style={{ 
