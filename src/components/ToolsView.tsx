...
export const ToolsView = ({ user, showToast }: ToolsViewProps) => {
 ...
 <div className="bg-white dark:bg-[#16161d] p-5 sm:p-8 rounded-none border border-slate-200 dark:border-white/5 space-y-6">
 <div className="flex items-center gap-3 mb-2">
 <div className="p-2 sm:p-3 bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded-none">
 ...
 className="w-full px-4 py-2.5 sm:py-3 bg-slate-50 dark:bg-[#16161d] border border-slate-200 dark:border-white/5 rounded-none text-xs sm:text-sm focus:border-blue-500 outline-none dark:text-white"
 />
 </div>
 <div>
 ...
 className="w-full px-4 py-2.5 sm:py-3 bg-slate-50 dark:bg-[#16161d] border border-slate-200 dark:border-white/5 rounded-none text-xs sm:text-sm focus:border-blue-500 outline-none dark:text-white resize-none"
 />
 </div>
 <button
 onClick={handleGenerate}
 className="w-full py-3 sm:py-4 bg-blue-600 text-white rounded-none font-medium text-xs sm:text-sm hover:bg-blue-700 flex items-center justify-center gap-2 uppercase tracking-widest"
 >
 ...
 <div className="bg-white dark:bg-[#16161d] p-5 sm:p-8 rounded-none border border-slate-200 dark:border-white/5 flex flex-col items-center justify-center text-center">
 {qrVisible ? (
 <motion.div
 ...
 >
 <div className="p-3 sm:p-4 bg-white rounded-none border-2 border-slate-50 inline-block mx-auto">
 <img
 ...
 type="text"
 value={generatedLink}
 className="w-full px-3 py-2 bg-slate-50 dark:bg-[#16161d] border border-slate-200 dark:border-white/5 rounded-none text-[10px] sm:text-xs text-blue-600 font-medium text-center"
 />
 </div>
 ...
 className="flex-1 py-2 sm:py-2.5 bg-slate-100 dark:bg-[#16161d] text-slate-600 dark:text-slate-200 rounded-none text-[10px] sm:text-xs font-bold hover:bg-slate-200 border border-slate-200 dark:border-white/5 "
 >
 Copy
 </button>
 <a
 ...
 target="_blank"
 rel="noreferrer"
 className="flex-1 py-2 sm:py-2.5 bg-blue-600 text-white rounded-none text-[10px] sm:text-xs font-bold hover:bg-blue-700 flex items-center justify-center"
 >
 Test
 </a>
 </div>
 ...
 <div className="space-y-4">
 <div className="w-16 h-16 sm:w-20 sm:h-20 bg-slate-50 dark:bg-slate-900 rounded-none flex items-center justify-center mx-auto">
 ...
 className="cursor-pointer bg-white dark:bg-[#16161d] p-5 sm:p-6 rounded-none border border-slate-200 dark:border-white/5 hover:border-blue-500 group flex flex-col justify-between"
 >
 <div>
 ...
 className="cursor-pointer bg-white dark:bg-[#16161d] p-5 sm:p-6 rounded-none border border-slate-200 dark:border-white/5 hover:border-emerald-500 group flex flex-col justify-between"
 >
 <div>
 <div className="flex items-center justify-between mb-4">
 <div className="p-2 sm:p-3 bg-emerald-50 dark:bg-emerald-900/30 text-emerald-600 dark:text-emerald-400 rounded-none">
 ...
 className="cursor-pointer bg-white dark:bg-[#16161d] p-5 sm:p-6 rounded-none border border-slate-200 dark:border-white/5 hover:border-purple-500 group flex flex-col justify-between"
 >
 <div>
 <div className="flex items-center justify-between mb-4">
 <div className="p-2 sm:p-3 bg-purple-50 dark:bg-purple-900/30 text-purple-600 dark:text-purple-400 rounded-none">
 ...
 className="cursor-pointer bg-white dark:bg-[#16161d] p-5 sm:p-6 rounded-none border border-slate-200 dark:border-white/5 hover:border-red-500 group flex flex-col justify-between"
 >
 <div>
 <div className="flex items-center justify-between mb-4">
 <div className="p-2 sm:p-3 bg-red-50 dark:bg-red-900/30 text-red-600 dark:text-red-400 rounded-none">
