...
export default function CampaignReport({ campaign, insights, accountName }: CampaignReportProps) {
  ...
  return (
    <div id="campaign-report-capture" className="bg-white text-slate-900 px-3 py-4 lg:p-10 w-full lg:w-[850px] mx-auto shadow-sm border-0 lg:border-2 border-slate-900 font-sans">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start gap-6 border-b-4 border-slate-900 pb-8 mb-8 px-2 sm:px-0">
        <div className="flex items-center gap-3 sm:gap-4">
          <div className="w-12 h-12 sm:w-16 sm:h-16 bg-blue-600 rounded-2xl flex items-center justify-center text-white shadow-lg shadow-blue-500/20 flex-shrink-0">
        ...
        <div className="text-left sm:text-right w-full sm:w-auto border-t sm:border-t-0 pt-4 sm:pt-0 border-slate-100 px-2 sm:px-0">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-blue-50 border border-blue-200 rounded text-blue-700 text-[10px] font-black uppercase mb-2">
      ...
      <div className="grid grid-cols-2 gap-4 lg:gap-8 mb-10 px-2 lg:px-0">
        ...
        <div className="col-span-2 lg:col-span-1 bg-slate-50 rounded-2xl p-4 sm:p-6 border-2 border-slate-900">
      ...
      <div className="mb-10 px-1 lg:px-0">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-4">
          {stats.map(s => (
            <div key={s.label} className="p-2 sm:p-4 border border-slate-200 rounded-xl text-center">
          ...
          <table className="w-full text-left border-collapse min-w-[500px]">
            <thead>
              <tr className="bg-slate-900 text-white">
                <th className="p-3 text-[10px] font-black uppercase tracking-widest rounded-tl-lg">KPI Metric</th>
                ...
                <th className="p-3 text-[10px] font-black uppercase tracking-widest rounded-tr-lg text-right">Benchmark</th>
              </tr>
            </thead>
