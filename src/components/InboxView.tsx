...
export const InboxView = ({
 ...
 <main className={`flex-1 min-h-0 flex flex-col bg-white dark:bg-[#16161d] overflow-hidden relative ${selectedChatId ? "flex" : "hidden lg:flex"}`}>
 {selectedChatId ? (
 <>
 <ChatHeader 
 ...
 <div className="flex items-center gap-4 px-5 py-4 bg-gradient-to-r from-amber-500 to-orange-600 rounded-none -amber-500/20">
 ...
 <button onClick={handleAcceptChat} className="px-4 py-2 bg-white text-amber-600 rounded-none text-[10px] font-black uppercase tracking-widest hover:scale-105 ">Accept</button>
 </div>
 </motion.div>
 )}
 ...
 disabled={aiLoading}
 className="w-10 h-10 bg-blue-600 hover:bg-blue-700 text-white rounded-none -blue-500/40 hover:scale-110 flex items-center justify-center border-2 border-white dark:border-[#16161d]"
 title="AI Sparkles"
 >
 {aiLoading ? <div className="w-4 h-4 border-2 border-white/30 border-t-white rounded-none " /> : <Sparkles size={18} />}
 </button>
 </div>
 ...
 <div className="w-24 h-24 mb-8 bg-blue-600/5 dark:bg-white/5 rounded-none flex items-center justify-center ">
 ...
 <div className="fixed inset-y-0 right-0 w-full sm:w-[350px] bg-white dark:bg-[#111b21] z-50 border-l border-slate-200 dark:border-white/10">
 <ChatProfile 
 selectedChat={selectedChat}
