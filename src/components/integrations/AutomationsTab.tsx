...
export const AutomationsTab = ({
 ...
 className="w-full px-3 py-2 bg-slate-50 dark:bg-[#202c33] border border-slate-200 dark:border-white/5 rounded-none text-sm outline-none focus:border-blue-500 dark:text-white"
 >
 ...
 className="py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-none font-bold text-[10px] uppercase tracking-widest flex items-center justify-center gap-2"
 >
 ...
 <tr key={auto.id} className="hover:bg-slate-50 dark:hover:bg-white/5 ">
 <td className="px-6 py-4 text-xs font-bold text-slate-900 dark:text-white">{auto.name}</td>
 <td className="px-6 py-4"><span className="px-2 py-0.5 bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 text-[9px] font-bold uppercase rounded-none border border-blue-100 dark:border-blue-900/50">{auto.event}</span></td>
