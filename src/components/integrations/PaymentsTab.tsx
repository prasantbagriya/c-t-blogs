    ...
    <div className="space-y-4">
       <div className="bg-white dark:bg-[#16161d] rounded-2xl border border-slate-200 dark:border-white/5 overflow-hidden shadow-sm">
        ...
        {connections.some(c => c.platform === 'google_sheets') && (
           <div className="m-6 p-5 bg-blue-600/5 dark:bg-blue-500/10 rounded-xl border border-blue-100 dark:border-blue-500/20">
                 ...
                 <div className="space-y-1.5">
                    ...
                    <div className="flex items-center gap-2 mt-2">
                       <input 
                         ...
                         className="flex-grow px-3 py-1.5 bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-lg text-[10px] font-mono text-slate-600 dark:text-slate-300 outline-none"
                       />
                       <button 
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left">
            ...
            <tbody className="divide-y divide-slate-50 dark:divide-white/5">
              {payments.map(pay => (
                <tr key={pay.id} className="hover:bg-slate-50 dark:hover:bg-white/5 transition-colors group">
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-1.5">
                      <div className={`w-1.5 h-1.5 rounded-full ${pay.status === 'paid' ? 'bg-emerald-500' : 'bg-amber-500'}`} />
