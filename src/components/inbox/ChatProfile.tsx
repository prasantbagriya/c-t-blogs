...
export const ChatProfile = ({
 ...
 <button onClick={onClose} className="p-1.5 hover:bg-slate-100 dark:hover:bg-white/5 rounded-none ">
 ...
 <div className="w-16 h-16 bg-blue-600 rounded-none flex items-center justify-center text-white text-xl font-bold mb-3 ">
 ...
 <div className="p-3 bg-slate-50 dark:bg-white/5 rounded-none border border-slate-200 dark:border-white/5">
 ...
 <button onClick={() => handleUpdateStatus({ status: 'Solved' })} className="py-2 bg-slate-50 dark:bg-white/5 hover:bg-slate-100 dark:hover:bg-white/10 text-slate-600 dark:text-slate-300 rounded-none text-[9px] font-bold uppercase tracking-widest border border-slate-200 dark:border-white/5 ">Solved</button>
 <button onClick={() => handleUpdateStatus({ status: 'Pending' })} className="py-2 bg-slate-50 dark:bg-white/5 hover:bg-slate-100 dark:hover:bg-white/10 text-slate-600 dark:text-slate-300 rounded-none text-[9px] font-bold uppercase tracking-widest border border-slate-200 dark:border-white/5 ">Pending</button>
 </div>
 <button onClick={() => handleUpdateStatus({ isHotLead: !selectedChat.isHotLead })} className={`w-full py-2 rounded-none text-[9px] font-bold uppercase tracking-widest flex items-center justify-center gap-2 ${selectedChat.isHotLead ? 'bg-rose-50 text-rose-600 border border-rose-100' : 'bg-slate-50 dark:bg-white/5 dark:hover:bg-white/10 text-slate-400 border border-slate-200 dark:border-white/5 hover:bg-slate-100'}`}>
 ...
 className="w-full p-3 bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/5 rounded-none text-xs outline-none focus:border-blue-500 text-slate-900 dark:text-white resize-none"
 rows={2}
 />
 <button
 onClick={handleCreateTicket}
 disabled={isUpdatingLead || !leadRemarks.trim()}
 className="w-full py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-none text-[10px] font-bold uppercase tracking-widest disabled:opacity-50 "
 >
 Create Ticket
 </button>
 </div>
 ...
 className="w-full py-2 text-rose-500 hover:bg-rose-50 rounded-none text-[9px] font-bold uppercase tracking-widest border border-rose-100 flex items-center justify-center gap-2"
 >
 <ShieldAlert size={14} />
 Block Contact
 </button>
