    ...
    <div className="flex flex-col space-y-1">
      {showDatePill && (
        <div className="flex justify-center my-4 sticky top-2 z-20">
          <span className="bg-slate-100 dark:bg-white/5 px-3 py-1 rounded-md text-[10px] font-medium text-slate-500 dark:text-slate-400 border border-slate-200 dark:border-white/5">
            {dateLabel}
          </span>
        </div>
      )}
      ...
      >
        <div className={`relative max-w-[85%] lg:max-w-[70%]`}>
          ...
          <div className={`
            px-3 py-1.5 rounded-xl text-[13px] font-medium shadow-sm leading-snug
            ${isMe 
              ? "bg-black dark:bg-white text-white dark:text-black" 
              : "bg-slate-100 dark:bg-[#16161d] text-slate-900 dark:text-slate-200"}
          `}>
        ...
        {pageChanged && msg.pageUrl && (
          <div className="mt-2 mb-2 self-center flex items-center gap-2 px-3 py-1 bg-slate-50 dark:bg-white/5 rounded-full border border-slate-200 dark:border-white/5">
