...
export const ProfileView = ({ user }: ProfileViewProps) => {
 ...
 <div className="bg-white dark:bg-[#16161d] p-4 sm:p-5 rounded-none border border-slate-200 dark:border-white/5 ">
 <div className="flex flex-col md:flex-row items-center gap-6 sm:gap-10">
 <div className="relative">
 <div className="w-28 h-28 sm:w-40 sm:h-40 rounded-none bg-slate-100 dark:bg-[#1a1a24] p-1 flex items-center justify-center border-2 border-slate-200 dark:border-white/5 overflow-hidden relative">
 {user?.photoURL ? (
 ...
 <label className="absolute -bottom-1.5 -right-1.5 w-10 h-10 bg-blue-600 text-white rounded-none flex items-center justify-center hover:bg-blue-700 cursor-pointer ">
 <Camera size={18} />
 ...
 <div className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-blue-50 text-blue-600 rounded-none text-[9px] font-medium border border-blue-100">
 ...
 <div className="bg-white dark:bg-[#16161d] p-4 sm:p-5 rounded-none border border-slate-200 dark:border-white/5 space-y-6">
 ...
 className="w-full px-4 py-3 bg-slate-50 dark:bg-[#1a1a24] border border-slate-200 dark:border-white/5 rounded-none text-sm font-medium outline-none focus:border-blue-500 dark:text-white"
 ...
 disabled
 className="w-full px-4 py-3 bg-slate-100 dark:bg-[#1a1a24] text-slate-700 dark:text-slate-200 rounded-none text-sm font-medium border border-slate-200 dark:border-white/5 cursor-not-allowed italic"
 />
 </div>
 ...
 <div className="bg-white dark:bg-[#1a1a24] p-4 sm:p-5 rounded-none text-slate-900 dark:text-white space-y-4 border border-slate-200 dark:border-white/5">
 <div>
 ...
 type="submit"
 disabled={isSaving}
 className={`w-full py-3 rounded-none font-medium text-[10px] uppercase tracking-widest flex items-center justify-center gap-2 ${ saveSuccess ? 'bg-emerald-500 text-white' : 'bg-blue-600 text-white hover:bg-blue-700 ' }`}
 >
 {isSaving ? (
 ...
 <div className="p-6 border border-slate-200 dark:border-white/5 rounded-none bg-slate-50 dark:bg-[#1a1a24]/50 space-y-3">
