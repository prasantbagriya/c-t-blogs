...
export const AgentManagementView = ({ user }: { user: any }) => {
 ...
 return (
 <div className="py-3 sm:py-4 lg:py-6 px-0 w-full space-y-6 fade-in ">
 {/* Header Area */}
 <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white dark:bg-[#16161d] p-6 rounded-none border border-slate-200 dark:border-white/5 ">
 ...
 className="pl-9 pr-4 py-2 bg-slate-50 dark:bg-[#1a1a24] border border-slate-200 dark:border-white/5 rounded-none text-xs outline-none focus:border-blue-500 w-64"
 />
 </div>
 <button 
 onClick={() => setShowAddModal(true)}
 className="flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-none text-xs font-bold uppercase tracking-widest hover:bg-blue-700 -blue-600/20"
 >
 ...
 <div key={agent.id} className="bg-white dark:bg-[#16161d] border border-slate-200 dark:border-white/5 rounded-none p-6 hover:border-blue-500/30 group relative overflow-hidden">
 <div className="absolute top-0 right-0 p-4">
 <div className="flex items-center gap-2">
 <span className={`w-2 h-2 rounded-none ${agent.status === 'online' ? 'bg-emerald-500 ' : 'bg-slate-300'}`} />
 <span className="text-[8px] font-bold text-slate-400 uppercase tracking-tighter">{agent.status}</span>
 </div>
 </div>

 <div className="flex items-center gap-4 mb-6">
 <div className="w-14 h-14 rounded-none bg-slate-50 dark:bg-[#1a1a24] border border-slate-100 dark:border-white/5 flex items-center justify-center text-xl font-bold text-blue-500">
 {agent.name[0]}
 </div>
 <div>
 <h3 className="text-sm font-bold text-slate-900 dark:text-white">{agent.name}</h3>
 <div className="flex items-center gap-2 mt-1">
 <span className="px-2 py-0.5 bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 rounded-none text-[8px] font-bold uppercase tracking-widest border border-blue-100 dark:border-blue-500/10">
 {agent.role}
 </span>
 ...
 <div className="p-3 bg-slate-50 dark:bg-[#1a1a24] rounded-none border border-slate-100 dark:border-white/5">
 ...
 <div className="flex items-center justify-between py-2 px-3 bg-slate-50 dark:bg-[#1a1a24] rounded-none border border-slate-100 dark:border-white/5">
 <div className="flex items-center gap-2">
 ...
 <div className="col-span-full py-20 flex flex-col items-center justify-center bg-slate-50/50 dark:bg-[#16161d]/50 border-2 border-dashed border-slate-200 dark:border-white/5 rounded-none">
 <div className="w-16 h-16 rounded-none bg-white dark:bg-[#1a1a24] flex items-center justify-center text-slate-300 mb-4">
 <Users size={32} />
 </div>
 ...
 className="fixed top-0 right-0 z-[101] w-full max-w-md h-full bg-white dark:bg-[#13131a] border-l border-slate-200 dark:border-white/10 flex flex-col"
 >
 ...
 <button onClick={() => setShowAddModal(false)} className="p-2 text-slate-400 hover:text-slate-600 dark:hover:text-white bg-white dark:bg-white/5 rounded-none border border-slate-200 dark:border-white/10">
 <X size={20} />
 </button>
 </div>
 ...
 className="w-full p-4 bg-slate-50 dark:bg-[#1a1a24] border border-slate-200 dark:border-white/5 rounded-none text-sm outline-none focus:border-blue-500 "
 />
 </div>
 <div className="space-y-1.5">
 ...
 <div className="p-6 bg-blue-50 dark:bg-blue-900/10 border border-blue-100 dark:border-blue-900/20 rounded-none">
 <div className="flex gap-3">
 <div className="p-2 bg-blue-100 dark:bg-blue-800 rounded-none h-fit">
 ...
 <button 
 onClick={() => setShowAddModal(false)}
 className="flex-1 px-4 py-4 bg-white dark:bg-[#1a1a24] border border-slate-200 dark:border-white/10 rounded-none text-[10px] font-bold uppercase tracking-[0.2em] text-slate-600 dark:text-slate-300 hover:bg-slate-100 "
 >
 Cancel
 </button>
 <button 
 onClick={handleAddAgent}
 className="flex-1 px-4 py-4 bg-blue-600 text-white rounded-none text-[10px] font-bold uppercase tracking-[0.2em] hover:bg-blue-700 -blue-600/20"
 >
 Create Profile
 </button>
 </div>
