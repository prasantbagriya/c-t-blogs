...
export const SalesDashboard = ({ user, messages, customerProfiles, departments: initialDepts, onChatSelect }: { user: any, messages?: any[], customerProfiles?: any[], departments?: any[], onChatSelect?: (phone: string) => void }) => {
 ...
 <div className=" h-8 w-8 border-2 border-blue-600 border-t-transparent rounded-none"></div>
 </div>
 );
 }
 ...
 <div className="flex bg-slate-100 dark:bg-[#1a1a24] p-1 rounded-none border border-slate-200 dark:border-white/5 mr-2">
 <button 
 onClick={() => setViewType('kanban')}
 className={`px-3 py-1.5 rounded-none text-[10px] font-bold uppercase tracking-wider ${viewType === 'kanban' ? 'bg-white dark:bg-slate-800 text-blue-600 ' : 'text-slate-400 hover:text-slate-600'}`}
 >
 Kanban
 </button>
 <button 
 onClick={() => setViewType('list')}
 className={`px-3 py-1.5 rounded-none text-[10px] font-bold uppercase tracking-wider ${viewType === 'list' ? 'bg-white dark:bg-slate-800 text-blue-600 ' : 'text-slate-400 hover:text-slate-600'}`}
 >
 List
 </button>
 </div>
 ...
 className="px-4 py-2 bg-slate-50 dark:bg-[#1a1a24] border border-slate-200 dark:border-white/5 rounded-none text-[10px] font-bold uppercase tracking-widest text-slate-600 dark:text-slate-200 outline-none focus:border-blue-500 "
 >
 ...
 <button className="flex-1 md:flex-none px-4 py-2 bg-blue-600 text-white rounded-none font-bold text-xs uppercase tracking-widest hover:bg-blue-700 flex items-center justify-center gap-2 -blue-600/20">
 <Plus size={14} /> Lead
 </button>
 </div>
 </div>
 ...
 {stats.map((stat) => (
 <div key={stat.label} className="p-4 bg-slate-50 dark:bg-[#1a1a24] rounded-none border border-slate-100 dark:border-white/5">
 ...
 <div className="p-1 bg-slate-100 dark:bg-[#1a1a24] rounded-none border border-transparent dark:border-white/5">{column.icon}</div>
 {column.label}
 </div>
 <span className="px-2 py-0.5 bg-slate-100 dark:bg-[#1a1a24] rounded-none text-[10px] font-bold text-slate-500 border border-transparent dark:border-white/5">
 ...
 className="bg-white dark:bg-[#16161d] p-4 rounded-none border border-slate-200 dark:border-white/5 group hover:border-blue-500/30"
 >
 <div className="flex justify-between items-start mb-3">
 <div className="flex items-center gap-3">
 <div className="w-9 h-9 bg-slate-100 dark:bg-[#1a1a24] rounded-none flex items-center justify-center text-blue-600 dark:text-blue-400 font-bold text-sm relative border border-slate-200 dark:border-white/5">
 {lead.name?.[0] || 'L'}
 {lead.isHotLead && (
 <span className="absolute -top-1 -right-1 w-3 h-3 bg-rose-500 text-white rounded-none flex items-center justify-center border border-white dark:border-slate-900">
 ...
 {lead.department && (
 <span className="px-1 py-0.5 bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 text-[7px] font-bold rounded-none uppercase">
 {lead.department}
 </span>
 )}
 </div>
 ...
 <div className="mb-4 p-2 bg-slate-50 dark:bg-[#1a1a24] rounded-none border border-slate-100 dark:border-white/5">
 ...
 className="p-1.5 hover:bg-blue-50 dark:hover:bg-blue-900/30 rounded-none text-blue-600 "
 >
 <MessageSquare size={14} />
 </button>
 <button className="p-1.5 hover:bg-emerald-50 dark:hover:bg-emerald-900/30 rounded-none text-emerald-600 ">
 <Phone size={14} />
 </button>
 </div>
 <button 
 onClick={() => updateStatus(lead.id, column.id === 'new' ? 'contacted' : 'closed')}
 className="p-1.5 bg-slate-50 dark:bg-[#1a1a24] hover:bg-blue-600 hover:text-white rounded-none text-slate-400 border border-transparent dark:border-white/5"
 >
 <ArrowRight size={14} />
 </button>
 </div>
 ...
 <div className="py-16 text-center border border-dashed border-slate-100 dark:border-white/10 rounded-none bg-slate-50/10">
 ...
 <tr key={lead.id} className="hover:bg-slate-50/50 dark:hover:bg-white/5 group">
 <td className="px-6 py-4">
 <div className="flex items-center gap-3">
 <div className="w-8 h-8 bg-blue-500/10 text-blue-600 rounded-none flex items-center justify-center font-bold text-xs uppercase">
 {lead.name?.[0] || 'L'}
 </div>
 <div>
 ...
 <td className="px-6 py-4">
 <span className="px-2 py-0.5 bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 text-[9px] rounded-none uppercase font-bold tracking-tight">
 ...
 className="p-2 hover:bg-amber-50 dark:hover:bg-amber-900/30 rounded-none text-amber-500 "
 ...
 <button 
 onClick={() => onChatSelect?.(lead.phone || lead.id)}
 className="p-2 hover:bg-blue-50 dark:hover:bg-blue-900/30 rounded-none text-blue-500 "
 >
 <MessageSquare size={14} />
 </button>
 </div>
