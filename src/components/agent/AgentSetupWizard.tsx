...
export const AgentSetupWizard = ({ user, onComplete }: AgentSetupWizardProps) => {
 ...
 <div className={`w-10 h-10 rounded-none flex items-center justify-center ${step >= s.id ? 'bg-blue-600 text-white' : 'bg-slate-100 dark:bg-slate-800 text-slate-400'}`}>
 <s.icon size={18} />
 </div>
 ...
 <motion.div 
 layout
 className="bg-white dark:bg-slate-900 w-full max-w-xl rounded-none border border-slate-200 dark:border-slate-200 overflow-hidden"
 >
 ...
 className={`w-full p-4 rounded-none border-2 flex items-center justify-between ${selectedAccountId === acc.id ? 'border-blue-600 bg-blue-50 dark:bg-blue-950' : 'border-slate-100 dark:border-slate-200'}`}
 >
 ...
 <button onClick={handleConnect} className="w-full p-4 rounded-none border border-dashed border-slate-200 text-[10px] font-medium uppercase tracking-widest text-slate-400 hover:text-blue-600 flex items-center justify-center gap-2">
 <Plus size={14} /> Link New Account
 </button>
 </div>
 ) : (
 <div className="p-10 bg-slate-50 dark:bg-slate-800/50 rounded-none text-center mb-10">
 ...
 <button onClick={handleConnect} className="px-6 py-3 bg-blue-600 text-white rounded-none font-medium text-[10px] uppercase tracking-widest hover:bg-blue-700 ">
 Link with Meta
 </button>
 </div>
 )}
 ...
 onClick={() => setStep(2)}
 className="bg-blue-600 text-white px-8 py-3 rounded-none font-medium text-[10px] uppercase tracking-widest flex items-center gap-2 disabled:opacity-50"
 >
 ...
 className="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-200 rounded-none py-4 pl-12 pr-4 text-sm font-medium focus:border-blue-600 outline-none dark:text-white font-mono"
 />
 </div>

 <div className="p-6 border border-emerald-100 dark:border-emerald-900/40 rounded-none bg-emerald-50 dark:bg-emerald-900/10 flex items-start gap-4">
 ...
 className="bg-blue-600 text-white px-8 py-3 rounded-none font-medium text-[10px] uppercase tracking-widest flex items-center gap-2 disabled:opacity-50"
 >
 {loading ? <Loader2 size={14} className="" /> : <ChevronRight size={14} />}
 ...
 className="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-200 rounded-none p-3 text-sm font-medium outline-none focus:border-blue-600 dark:text-white"
 />
 </div>
 <div>
 ...
 className={`px-4 py-2 rounded-none text-[9px] font-medium uppercase tracking-wider ${persona === p ? 'bg-blue-600 text-white' : 'bg-slate-100 dark:bg-slate-800 text-slate-400'}`}
 >
 {p}
 </button>
 ))}
 ...
 className="bg-blue-600 text-white px-8 py-3 rounded-none font-medium text-[10px] uppercase tracking-widest flex items-center gap-2 disabled:opacity-50"
 >
 {loading ? <Loader2 size={14} className="" /> : <Sparkles size={14} />}
 Launch Agent
 </button>
 </div>
 </motion.div>
 ...
 >
 <div className="w-20 h-20 bg-emerald-50 dark:bg-emerald-900/20 rounded-none flex items-center justify-center mx-auto mb-8">
 ...
 className="w-full bg-slate-900 dark:bg-slate-800 text-white py-4 rounded-none font-medium text-[10px] uppercase tracking-widest hover:bg-black "
 >
 Go to Dashboard
 </button>
 </motion.div>
