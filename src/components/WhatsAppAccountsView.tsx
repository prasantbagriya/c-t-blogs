...
export const WhatsAppAccountsView = ({ user, onManage }: WhatsAppAccountsViewProps) => {
 ...
 <div className="bg-white dark:bg-[#16161d] p-3.5 sm:p-6 rounded-none border border-slate-200 dark:border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
 ...
 className="bg-blue-600 text-white px-5 py-2.5 sm:px-6 sm:py-3 rounded-none font-medium text-sm hover:bg-blue-700 flex items-center gap-2"
 >
 ...
 {loading ? (
 [1, 2, 3].map(i => (
 <div key={i} className="bg-white dark:bg-[#16161d] p-4 sm:p-5 rounded-none border border-slate-200 dark:border-white/5 h-48" />
 ))
 ) : accounts.length === 0 ? (
 <div className="col-span-full bg-slate-50 dark:bg-[#16161d]/50 p-16 rounded-none border border-slate-200 dark:border-white/5 text-center">
 ...
 className="bg-blue-600 text-white px-8 py-3 rounded-none font-bold text-xs uppercase tracking-wider hover:bg-blue-700"
 >
 Connect with Meta
 </button>
 </div>
 ...
 <div 
 key={acc.id}
 className="bg-white dark:bg-[#16161d] p-3 rounded-none border border-slate-200 dark:border-white/5 flex flex-col justify-between"
 >
 <div>
 <div className="flex justify-between items-center mb-3">
 <div className={`w-8 h-8 rounded-none flex items-center justify-center ${acc.status === 'active' ? 'bg-blue-50 text-blue-600' : 'bg-rose-50 text-rose-500'}`}>
 <MessageCircle className="w-4 h-4" />
 </div>
 <div className="flex items-center gap-2">
 <span className={`px-1.5 py-0.5 rounded-none text-[8px] font-medium uppercase tracking-wider ${acc.status === 'active' ? 'bg-emerald-50 text-emerald-600 border border-emerald-100' : 'bg-rose-50 text-rose-600 border border-rose-100'}`}>
 ...
 className={`w-full py-2 rounded-none font-medium text-[9px] uppercase tracking-widest flex items-center justify-center gap-2 ${ acc.status === 'pending_config' ? 'bg-rose-600 text-white hover:bg-rose-700' : 'bg-blue-600 text-white hover:bg-blue-700' }`}
 >
 ...
 <div className="bg-white dark:bg-[#13131a] w-full max-w-md rounded-none overflow-hidden border border-slate-200 dark:border-white/10">
 <div className="p-8">
 ...
 <div className="p-8 bg-blue-600 text-white rounded-none">
 ...
 <button 
 onClick={handleConnectWithFacebook}
 className="w-full py-3 bg-white text-blue-600 rounded-none font-medium text-sm"
 >
 Connect with Meta
 </button>
 </div>
