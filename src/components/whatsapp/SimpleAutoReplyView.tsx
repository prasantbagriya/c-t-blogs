...
export const SimpleAutoReplyView = ({ user, selectedAccount }: SimpleAutoReplyViewProps) => {
 ...
 return (
 <div className="py-3 sm:py-4 lg:py-6 px-0 w-full space-y-4 sm:space-y-6">
 ...
 <div className="bg-white dark:bg-[#16161d] border border-slate-200 dark:border-white/5 rounded-none p-4 sm:p-6 space-y-4 sm:space-y-6">
 ...
 rows={6}
 className="w-full bg-slate-50 dark:bg-[#1a1a24] border border-slate-100 dark:border-white/5 rounded-none p-4 text-slate-900 dark:text-white font-medium focus:ring-2 focus:ring-blue-500/20 outline-none resize-none"
 />
 ...
 onClick={handleSave}
 disabled={isSaving}
 className="px-10 py-2.5 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-none disabled:opacity-50"
 >
 ...
 <div className="p-6 bg-emerald-50 dark:bg-emerald-900/10 border border-emerald-100 dark:border-emerald-900/20 rounded-none">
