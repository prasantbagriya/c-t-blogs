...
export function WhatsAppBulkSendView({ user, onSuccess, selectedAccount, onNavigate }: WhatsAppBulkSendViewProps) {
 ...
 return <span key={`v-${i}`} className="bg-blue-100 dark:bg-blue-900 text-blue-600 dark:text-blue-400 px-1 rounded-none font-black">{val || part}</span>;
 }
 return part;
 });
 ...
 return (
 <div className="flex flex-col lg:flex-row bg-white dark:bg-[#16161d] text-slate-900 dark:text-white">
 ...
 <button onClick={() => setIsSidebarOpen(false)} className="p-2 text-slate-500 hover:text-slate-300 ">
 <X size={16} />
 </button>
 </div>
 ...
 className="w-full bg-[#1a1a24] border border-white/5 rounded-none py-2 pl-10 pr-4 text-xs outline-none focus:border-blue-500 text-white"
 />
 </div>
 </div>
 ...
 {loading ? (
 <div className="py-10 text-center"><RefreshCw size={16} className="mx-auto text-slate-300" /></div>
 ) : templates.length === 0 ? (
 <div className="py-10 text-center flex flex-col items-center gap-3">
 <p className="text-[10px] font-medium text-slate-400">No approved templates found</p>
 {onNavigate && (
 <button 
 onClick={() => onNavigate('templates')}
 className="px-4 py-2 bg-blue-600 text-white text-[10px] uppercase font-bold tracking-widest rounded-none"
 >
 Manage Templates
 </button>
 )}
 ...
 className={cn(
 "w-full text-left rounded-none p-3 border flex items-center gap-3",
 selectedTemplate?.id === t.id ? 'bg-blue-600 border-blue-600 text-white ring-1 ring-white/10' : 'bg-[#1a1a24] border-white/5 hover:border-slate-700 text-slate-100'
 )}
 >
 <div className={cn(
 ...
 className="p-2 border border-slate-200 dark:border-white/5 rounded-none hover:bg-slate-50 dark:hover:bg-white/10 dark:hover:text-white"
 >
 ...
 <div className="bg-white dark:bg-[#16161d] border border-slate-200 dark:border-white/5 rounded-none p-6 space-y-6">
 <div className="flex items-center justify-between">
 <h2 className="text-[10px] font-bold text-slate-700 dark:text-slate-200 uppercase tracking-widest">Recipients</h2>
 <span className="text-[10px] font-bold text-blue-600 bg-blue-50 dark:bg-blue-900/40 px-2 py-0.5 rounded-none border border-blue-100 dark:border-blue-800">
 {parsedRecipients.length} Set
 </span>
 </div>

 <div className="flex flex-col sm:flex-row gap-3">
 <div className="flex-1 flex items-center gap-3 p-4 bg-slate-50 dark:bg-[#1a1a24] border border-slate-200 dark:border-white/5 rounded-none border-dashed cursor-pointer hover:bg-blue-50 dark:hover:bg-blue-900/10 hover:border-blue-400 group" 
 ...
 className="px-4 py-4 bg-slate-50 dark:bg-[#1a1a24] border border-slate-200 dark:border-white/5 rounded-none text-slate-600 dark:text-slate-200 hover:bg-emerald-50 dark:hover:bg-emerald-900/10 hover:border-emerald-400 flex items-center justify-center gap-2"
 ...
 className="w-full h-48 bg-slate-50 dark:bg-[#1a1a24] border border-slate-200 dark:border-white/5 rounded-none p-4 text-xs font-medium outline-none focus:border-blue-500 resize-none dark:text-white"
 />
 </div>
 ...
 <div className="bg-white dark:bg-[#16161d] border border-slate-200 dark:border-white/5 rounded-none overflow-hidden flex flex-col">
 ...
 <span className="text-[8px] font-bold text-emerald-500 uppercase tracking-tighter bg-emerald-50 dark:bg-emerald-950/30 px-2 py-0.5 rounded-none border border-emerald-100 dark:border-emerald-900/40 flex items-center gap-1">
 ...
 <tr key={i} className="border-b border-slate-50 dark:border-white/5 last:border-0 hover:bg-slate-50 dark:hover:bg-white/10 dark:hover:text-white/50">
 ...
 className="w-full border border-slate-200 dark:border-white/5 bg-slate-50 dark:bg-[#1a1a24] rounded-none py-2 px-3 text-xs font-bold outline-none focus:border-blue-500 dark:text-white"
 />
 </div>
 ))}
 </div>
 ...
 onClick={handleSend}
 className="w-full py-3.5 bg-blue-600 text-white rounded-none font-medium text-sm hover:bg-blue-700 flex items-center justify-center gap-2 disabled:opacity-30"
 >
 {sending ? <RefreshCw size={16} /> : <Rocket size={16} />}
 ...
 <div className="w-1.5 h-1.5 rounded-none bg-slate-300" />
 </div>
 </div>

 <div className="bg-[#e5ddd5] dark:bg-[#0b141a] rounded-none p-4 border-8 border-slate-900 dark:border-[#202c33] h-[500px] flex flex-col relative">
 ...
 {selectedAccount?.isVerified && <div className="w-2.5 h-2.5 bg-blue-500 rounded-none flex items-center justify-center border-[0.5px] border-white/20"><Check size={6} className="text-white" strokeWidth={4} /></div>}
 </p>
 ...
 <div className="bg-white dark:bg-[#202c33] rounded-none border border-slate-100 dark:border-white/5 p-2 max-w-[95%] relative">
 ...
 <div className="p-4 border border-slate-100 dark:border-white/5 rounded-none bg-slate-50/50 dark:bg-[#1a1a24]/50 text-emerald-600">
 ...
 <div className="bg-white dark:bg-[#16161d] w-full max-w-md rounded-none border border-slate-200 dark:border-white/10 overflow-hidden flex flex-col">
 ...
 <button onClick={() => setIsAudienceModalOpen(false)} className="text-slate-400 hover:text-slate-600 dark:hover:text-white">
 <X className="w-5 h-5" />
 </button>
 </div>
 ...
 className="w-full text-left p-4 rounded-none border border-slate-200 dark:border-white/5 bg-slate-50 dark:bg-[#1a1a24] hover:border-blue-500 hover:bg-blue-50 dark:hover:bg-blue-900/10 flex items-center justify-between"
 >
 <div>
 ...
 <div className="bg-slate-200 dark:bg-white/10 text-slate-700 dark:text-slate-300 text-[10px] font-bold px-2 py-1 rounded-none">
 {userContacts.length}
 </div>
 </button>
 ...
 <div className="bg-blue-100 dark:bg-blue-900/30 text-blue-600 text-[10px] font-bold px-2 py-1 rounded-none">
 {count}
 </div>
 </button>
 );
