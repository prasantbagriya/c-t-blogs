      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-6 gap-6 lg:gap-8">
          ...
          {[
              ...
              content: (
                <div className="space-y-4">
                  ...
                  {[['Facebook', 'bg-blue-500', '85%'], ['Instagram', 'bg-pink-500', '70%'], ['TikTok', 'bg-yellow-400', '50%'], ['Snapchat', 'bg-teal-400', '95%']].map(([n, c, w]) => (
                    <div key={n} className={`${c} h-5 rounded flex items-center px-3 text-[10px] font-bold text-white shadow-lg`} style={{ width: w }}>{n}</div>
                  ))}
              ...
              content: (
                <div className="space-y-4">
                  <div className="flex items-center space-x-3 mb-6">
                    <div className="w-8 h-8 bg-white rounded-full flex items-center justify-center font-black text-blue-500 text-lg shadow-inner">G</div>
                    <div>
            ...
            <div key={i} className="md:col-span-3 group relative bg-slate-900/40 backdrop-blur-md rounded-2xl border border-white/10 p-8 overflow-hidden hover:border-blue-500/50 transition-colors flex flex-col justify-between min-h-[420px]">
              <GlowingEffect blur={0} borderWidth={1.5} spread={60} glowproximity={80} inactiveZone={0.01} />
              <div className="relative z-10 flex flex-col h-full">
                <div className="bg-slate-950/50 rounded-xl p-6 border border-white/10 shadow-2xl mb-8">
                  {s.content}
                </div>
                <div className="mt-auto">
                  <h3 className={`text-2xl font-bold text-white mb-3 group-hover:text-${s.color}-400 transition-colors`}>{s.title}</h3>
          ...
          {[
              ...
              content: (
                <div className="w-full h-full space-y-3">
                   ...
                   <div className="w-full h-12 bg-white/5 rounded-lg border border-white/5 relative">
                      ...
                      <div className="absolute right-2 bottom-2 px-3 py-1 bg-blue-600 rounded-md text-[8px] font-bold text-white uppercase tracking-widest shadow-lg">Send</div>
                   </div>
                </div>
              )
            },
                   ...
                   <div className="grid grid-cols-2 gap-3">
                      ...
                      <div className="bg-white/5 p-3 rounded-lg border border-white/5">
                         ...
                         <div className="w-full h-1.5 bg-gray-800 rounded-full mt-1.5 overflow-hidden">
                            <div className="h-full bg-green-500 w-[80%] rounded-full shadow-[0_0_8px_rgba(34,197,94,0.5)]" />
                         </div>
                      </div>
                   </div>
                </div>
            ...
            <div key={i} className="md:col-span-2 group relative bg-slate-900/40 backdrop-blur-md rounded-2xl border border-white/10 p-6 overflow-hidden hover:border-blue-500/50 transition-colors min-h-[350px] flex flex-col">
              <GlowingEffect blur={0} borderWidth={1.5} spread={60} glowproximity={80} inactiveZone={0.01} />
              <div className="relative z-10 flex flex-col h-full">
          ...
          <div className="md:col-span-6 group relative bg-slate-900/40 backdrop-blur-md rounded-2xl border border-white/10 overflow-hidden hover:border-blue-500/50 transition-colors min-h-[320px]">
            <GlowingEffect blur={0} borderWidth={1.5} spread={60} glowproximity={80} inactiveZone={0.01} />
            <div className="relative z-10 p-8 lg:p-12 flex flex-col md:flex-row gap-12 items-center">
              <div className="md:w-1/3 flex flex-col space-y-6 text-center md:text-left">
                <div>
                  <h3 className="text-3xl font-bold text-white mb-4 group-hover:text-blue-400 transition-colors tracking-tight">Web Development</h3>
              ...
              <div className="md:w-2/3 w-full group-hover:scale-[1.02] transition-transform duration-500">
