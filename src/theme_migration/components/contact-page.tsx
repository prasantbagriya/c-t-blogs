      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <motion.div 
            ...
            className="space-y-8"
          >
            <div className="bg-gray-900/50 border border-gray-800 rounded-3xl p-5 sm:p-8 backdrop-blur-sm">
              ...
              <ul className="space-y-4">
                {[
                  ...
                  <li key={i} className="flex items-start space-x-3 group">
                    <div className="w-5 h-5 bg-blue-500/20 rounded-full flex items-center justify-center mt-0.5 group-hover:bg-blue-500/40 ">
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input 
                      ...
                      className="w-full px-6 py-4 bg-gray-800 border border-gray-700 rounded-2xl text-white placeholder-gray-500 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 font-medium"
                ...
                <div className="space-y-2">
                  ...
                  <textarea 
                    ...
                    className="w-full px-6 py-4 bg-gray-800 border border-gray-700 rounded-2xl text-white placeholder-gray-500 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 font-medium resize-none"
                ...
                <button type="submit" disabled={isSubmitting} className="group relative w-full mt-4">
                  <div className="relative inline-block w-full rounded-2xl overflow-visible" style={{ perspective: '600px' }}>
                    <div className="absolute -inset-0.5 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity bg-[linear-gradient(45deg,#ff0000,#ff7f00,#ffff00,#00ff00,#0000ff,#4b0082,#9400d3)] bg-[length:400%_400%] animate-rainbow blur-[2px]" />
                    <motion.div 
                      className="relative z-10 rounded-2xl bg-white text-black px-10 py-5 font-black uppercase tracking-widest text-sm flex items-center justify-center gap-3 group-hover:bg-gray-50 "
                      whileHover={{ rotateX: 10 }}
                      style={{ transformStyle: 'preserve-3d', transformOrigin: 'center bottom' }}
                    >
                      {isSubmitting ? <Loader2 className="w-5 h-5 " /> : <Send className="w-5 h-5 text-blue-600" />}
