  ...
  return (
    <section className="py-10 bg-transparent relative overflow-hidden font-sans">
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        ...
        >
          <span className="inline-block py-1.5 px-4 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-400 text-xs font-bold tracking-widest uppercase mb-6 shadow-sm">
            Tier Structure
          </span>
          ...
          <button 
            ...
            className="inline-flex items-center gap-2 bg-blue-500 hover:bg-blue-400 text-white px-8 py-4 rounded-full font-bold transition-all hover:scale-105 active:scale-95 shadow-[0_0_30px_rgba(99,102,241,0.2)]"
          >
            Talk to an Expert
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {plans.map((plan, i) => (
            ...
            >
              <div className={`relative h-full bg-slate-900/40 backdrop-blur-xl border ${plan.highlight ? 'border-blue-500/50 shadow-[0_0_40px_rgba(99,102,241,0.15)]' : 'border-white/10'} rounded-[2rem] p-8 flex flex-col hover:border-blue-500/50 transition-colors overflow-hidden`}>
                ...
                <div className="relative z-10 flex flex-col h-full">
                   <div className="mb-8">
                     <div className="flex justify-between items-center mb-4">
                        ...
                        {plan.highlight && (
                          <span className="px-3 py-1 bg-blue-500 text-white text-[10px] font-black uppercase tracking-widest rounded-full shadow-lg">Most Popular</span>
                        )}
                     </div>
                   ...
                   <ul className="space-y-4 mb-10 flex-grow">
                    ...
                    <button
                      ...
                      className={`w-full py-4 rounded-2xl font-bold tracking-widest uppercase text-xs transition-all ${
                        plan.highlight 
                         ? 'bg-gradient-to-r from-blue-600 to-purple-600 text-white hover:shadow-[0_0_30px_rgba(99,102,241,0.4)]' 
