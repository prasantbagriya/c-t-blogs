                ...
                <div className="space-y-8">
                  <div className="flex items-center justify-between">
                    ...
                    <button 
                      type="button"
                      onClick={addField}
                      className="p-2 bg-blue-500/10 text-blue-400 rounded-lg hover:bg-blue-500/20 transition-all active:scale-95 flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest border border-blue-500/20"
                    >
                        ...
                        {fields.map((field, index) => (
                          ...
                          >
                            <button 
                              ...
                              className="absolute top-4 right-4 text-gray-600 hover:text-rose-500 transition-colors opacity-0 group-hover/field:opacity-100"
                            >
                            ...
                            <div className="grid grid-cols-2 gap-4">
                              <div>
                                ...
                                <input 
                                  ...
                                  className="w-full bg-transparent border-b border-white/10 text-white text-xs py-1 outline-none focus:border-blue-500/50 transition-all font-medium"
                                />
                              </div>
                              <div>
            ...
            <div className="mt-32">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                {[
                  ...
                  <div key={i} className="p-8 bg-white/5 border border-white/10 rounded-[2.5rem] hover:bg-white/10 transition-all hover:-translate-y-2 group">
