        ...
        >
          ...
          >
            <a
              ...
              className="inline-flex items-center px-6 py-3 bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl text-sm text-gray-300 hover:border-blue-500/50 hover:bg-white/10 group"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {artistServices.map((service, index) => (
              <motion.div
                ...
                className="relative bg-gray-900/10 border border-gray-800 rounded-[2rem] p-8 backdrop-blur-sm group overflow-hidden"
              >
                <GlowingEffect
                  blur={0}
                  borderWidth={1.5}
                  ...
                  inactiveZone={0.01}
                />
                <div className="text-blue-400 mb-8 bg-blue-500/10 w-16 h-16 rounded-2xl flex items-center justify-center border border-blue-500/20 group-hover:scale-110 group-hover:bg-blue-500/20 ">
                  {service.icon}
                </div>
                <h3 className="text-2xl font-bold text-white mb-4 group-hover:text-blue-400 ">
                  {service.title}
                </h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {caseStudies.map((study, index) => (
              <motion.div
                ...
                className="bg-gray-900/5 backdrop-blur-sm border border-white/5 rounded-[3rem] overflow-hidden group hover:border-white/10 relative"
              >
                <GlowingEffect
                  blur={0}
                  borderWidth={1.5}
                ...
                <div className="relative z-10">
                  <div className="aspect-video bg-gray-900/50 relative overflow-hidden">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <Music className="w-20 h-20 text-white/5 group-hover:scale-110 group-hover:text-white/10 " />
                    </div>
