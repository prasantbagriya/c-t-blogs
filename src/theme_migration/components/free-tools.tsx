              ...
              >
                <div className="space-y-8">
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <input 
                            ...
                            className="w-full pl-12 pr-5 py-4 bg-white/5 border border-white/10 rounded-2xl text-white focus:border-blue-500/50 outline-none transition-all placeholder:text-gray-700 font-medium"
                          />
                        </div>
                      </div>
                  ...
                  <button 
                    ...
                    className="w-full py-5 bg-white text-black rounded-2xl font-bold text-sm hover:-translate-y-1 hover:shadow-2xl active:scale-95 transition-all duration-300 flex items-center justify-center gap-3"
                  >
                      ...
                      <div>
                        ...
                        <div className="space-y-6">
                          ...
                          <div className="flex flex-col sm:flex-row gap-3">
                            <button 
                              onClick={handleCopy}
                              className="flex-1 items-center justify-center gap-2 py-4 bg-white text-black rounded-xl font-bold text-[11px] hover:-translate-y-1 hover:shadow-xl active:scale-95 transition-all duration-300 flex uppercase tracking-wider"
                            >
                            ...
                            <button 
                              onClick={downloadQR}
                              className="flex-1 items-center justify-center gap-2 py-4 bg-white/5 border border-white/10 text-white rounded-xl font-bold text-[11px] hover:bg-white/10 hover:-translate-y-1 active:scale-95 transition-all duration-300 flex uppercase tracking-wider"
                            >
                          ...
                          <div className="pt-6 border-t border-white/5 flex items-center justify-between">
                            <button 
                              ...
                              className="flex items-center gap-2 text-gray-600 hover:text-white transition-colors text-[9px] font-bold uppercase tracking-widest"
                            >
                            ...
                            <a 
                              ...
                              target="_blank" 
                              rel="noreferrer"
                              className="flex items-center gap-1 text-blue-400 hover:text-blue-300 transition-colors text-[9px] font-bold uppercase tracking-widest group"
                            >
                              Live Test 
            ...
            <section className="mt-24" aria-labelledby="features-heading">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {[
                  ...
                  <div key={i} className="p-8 bg-black/40 backdrop-blur-xl border border-white/10 rounded-[2.5rem] hover:border-blue-500/50 transition-colors group text-center">
            ...
            <div className="mt-32">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                {[
                  ...
                  <div key={i} className="p-8 bg-white/5 border border-white/10 rounded-[2rem] hover:bg-white/10 transition-all hover:-translate-y-2 group">
            ...
            <div className="mt-32 mb-20 max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                {[
                  ...
                  <div key={i} className="p-8 bg-white/5 border border-white/10 rounded-[2rem] hover:border-blue-500/30 transition-colors">
              ...
              >
                ...
                <div className="relative z-10 max-w-2xl mx-auto space-y-8">
                  ...
                  <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
                    <button className="bg-white text-black px-10 py-5 rounded-2xl font-bold text-sm hover:-translate-y-1 hover:shadow-[0_0_30px_rgba(255,255,255,0.2)] active:scale-95 transition-all duration-300 flex items-center gap-3">
                      Get Started Free <ArrowRight className="w-4 h-4" />
                    </button>
                    <button className="text-white hover:text-blue-400 px-10 py-5 font-bold text-sm transition-colors">
                      Learn More
                    </button>
                  </div>
                </div>
