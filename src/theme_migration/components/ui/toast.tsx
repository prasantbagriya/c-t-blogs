...
export default function Toast({ message, type = "info", onClose, duration = 4000 }: ToastProps) {
  ...
  return (
    <motion.div
      ...
      className={`fixed bottom-8 left-1/2 -translate-x-1/2 z-[100] flex items-center gap-3 px-4 py-3 rounded-2xl border backdrop-blur-xl shadow-2xl min-w-[320px] max-w-[90vw] ${styles[type]}`}
    >
