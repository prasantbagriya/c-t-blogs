          ...
          <AnimatePresence mode="wait">
            ...
            {currentStep === 0 && (
              <motion.div
                ...
                className="flex-1"
              >
                <h2 className="text-3xl font-bold text-gray-900 mb-4">What type of business do you have?</h2>
                <p className="text-gray-600 mb-8">This helps us customize our recommendations for your industry.</p>
                      ...
                      <div className="flex items-center space-x-4 mb-3">
                        <div
                          className={`p-3 rounded-lg ${
                            formData.businessType === business.id ? "bg-blue-100 text-blue-600" : "bg-gray-200 text-gray-600"
                          }`}
                        >
                          {business.icon}
                        </div>
            ...
            {currentStep === 1 && (
              <motion.div
                ...
                className="flex-1"
              >
                <h2 className="text-3xl font-bold text-gray-900 mb-4">What&apos;s your monthly marketing budget?</h2>
            ...
            {currentStep === 2 && (
              <motion.div
                ...
                className="flex-1"
              >
                <h2 className="text-3xl font-bold text-gray-900 mb-4">Which services interest you most?</h2>
                <p className="text-gray-600 mb-8">
                  ...
                  {services.map((service) => (
                    ...
                    >
                      <div className="flex items-center justify-between mb-2">
                        ...
                        {formData.services.includes(service.id) && <Check className="w-5 h-5 text-blue-600" />}
                      </div>
            ...
            {currentStep === 3 && (
              <motion.div
                ...
                className="flex-1"
              >
                <h2 className="text-3xl font-bold text-gray-900 mb-4">What are your primary goals?</h2>
                <p className="text-gray-600 mb-8">Help us understand what success looks like for your business.</p>
                  ...
                  {goals.map((goal) => (
                    ...
                    >
                      <div className="flex items-center space-x-4">
                        <div
                          className={`p-3 rounded-lg ${
                            formData.goals.includes(goal.id) ? "bg-blue-100 text-blue-600" : "bg-gray-200 text-gray-600"
                          }`}
                        >
                          {goal.icon}
                        </div>
                        ...
                        {formData.goals.includes(goal.id) && <Check className="w-5 h-5 text-blue-600" />}
                      </div>
                    </motion.button>
                  ))}
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg text-gray-900 placeholder-gray-400 focus:outline-none focus:border-blue-500"
                ...
                <div className="bg-gray-50 rounded-2xl p-6 mb-8 border border-gray-200">
                  ...
                  <div className="space-y-3 text-left">
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="text-gray-700">We&apos;ll analyze your responses and create a custom strategy</span>
                    </div>
                    <div className="flex items-center space-x-3">
                      <div className="w-6 h-6 bg-blue-500 rounded-full flex items-center justify-center text-white text-sm font-bold">
                        2
