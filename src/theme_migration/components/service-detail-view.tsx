      ...
      <main className="pt-32 pb-24 px-4 overflow-hidden">
        <div className="max-w-7xl mx-auto">
          ...
          <motion.button
            ...
            onClick={onBack}
            className="group flex items-center gap-3 text-xs font-black uppercase tracking-[0.3em] text-gray-500 hover:text-white transition-colors mb-16"
          >
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center mb-32">
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="relative bg-white/5 backdrop-blur-3xl rounded-[4rem] p-12 lg:p-20 border border-white/10 overflow-hidden shadow-[0_0_100px_rgba(99,102,241,0.1)]">
                 <motion.div
                ...
                <div className="relative z-10 flex flex-col items-center justify-center text-center">
                  <div className="w-32 h-32 bg-blue-500/10 rounded-[2.5rem] flex items-center justify-center mb-8 border border-blue-500/20 shadow-[0_0_50px_rgba(99,102,241,0.2)]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-32">
            {service.stats.map((stat: any, index: number) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="bg-white/5 rounded-[2.5rem] p-10 border border-white/5 text-center group hover:bg-white/10 transition-all cursor-default"
              >
