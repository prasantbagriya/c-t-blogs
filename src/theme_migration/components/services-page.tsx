        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {SERVICES.map((service, index) => (
            <motion.div
              ...
              className="relative bg-white/5 border-[1.5px] rounded-[2.5rem] p-10 backdrop-blur-xl group overflow-hidden"
            >
               <motion.div
              ...
              <div className="relative z-10">
                <div className="w-16 h-16 bg-white/5 rounded-2xl flex items-center justify-center mb-8 border border-white/10 group-hover:bg-blue-500/10 group-hover:border-blue-500/20 ">
                  <div className="text-blue-400 group-hover:scale-110 transition-transform">{service.icon}</div>
                </div>
                <h3 className="text-3xl font-bold text-white mb-4 group-hover:text-blue-400 tracking-tight">
                  {service.title}
                </h3>
                ...
                <Link href={`/services/${service.id}`}>
                  <button className="bg-white text-black w-full py-4 rounded-2xl font-bold text-lg hover: cursor-pointer">
                    Explore Details
                  </button>
                </Link>
              </div>
