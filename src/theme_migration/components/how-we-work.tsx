        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {STEPS.map((step, index) => (
            <motion.div 
              ...
              whileHover={{ y: -10 }}
              className={`bg-slate-950 rounded-[2.5rem] p-8 backdrop-blur-sm border border-white/5 group relative overflow-hidden h-full`}
            >
              <GlowingEffect
                blur={0}
                borderWidth={1.5}
                      ...
                      <div className="w-full max-w-[160px] space-y-3">
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <motion.div
                            ...
                            className="w-4 h-4 border border-green-500 border-t-transparent rounded-full "
                          ></motion.div>
                        </div>
                        <div className="space-y-2">
                          {[
                            ...
                            <div key={i} className="flex items-center gap-2">
                              <div className={`w-2 h-2 ${item.color} rounded-full ${item.pulse ? '' : ''}`} />
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-4">
                  <div className="text-4xl font-black text-white group-hover:text-opacity-100 text-opacity-30 ">{step.number}</div>
