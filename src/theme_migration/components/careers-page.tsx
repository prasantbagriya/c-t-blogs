    ...
    <div className="relative pt-32 pb-24 font-sans">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="space-y-8">
          ...
          {jobs.map((job, index) => (
            <motion.div
              ...
              className="group relative bg-white/5 border border-white/10 rounded-[2.5rem] p-6 md:p-10 hover:bg-white/[0.08] hover:border-blue-500/30 overflow-hidden"
            >
              <GlowingEffect
                blur={0}
                borderWidth={1.5}
              ...
              <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-8">
                <div className="flex-1">
                  ...
                  <h3 className="text-xl md:text-2xl font-bold text-white mb-4 group-hover:text-blue-400 ">
                    {job.title}
                  </h3>
                ...
                <div className="shrink-0">
                  <button className="bg-white text-black px-8 py-4 rounded-2xl font-bold flex items-center gap-2 hover: ">
                    Apply Now
                    <ArrowRight className="w-4 h-4 group- transition-transform" />
                  </button>
                </div>
              </div>
            </motion.div>
        ...
        >
          ...
          <a href="mailto:careers@chatwizs.com" className="inline-flex items-center text-blue-400 font-bold hover:text-blue-300 gap-2 text-base md:text-lg break-all">
