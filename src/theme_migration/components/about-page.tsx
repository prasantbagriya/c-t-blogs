        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center mb-40">
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 pt-6">
              <div className="p-6 sm:p-8 bg-white/5 rounded-3xl border border-white/5 hover:border-blue-500/30 group">
                <p className="text-3xl sm:text-4xl font-black text-white mb-2 group-hover:text-blue-400 ">99.9%</p>
                <p className="text-[10px] font-black text-gray-500 uppercase tracking-widest">Uptime Guarantee</p>
              </div>
              <div className="p-6 sm:p-8 bg-white/5 rounded-3xl border border-white/5 hover:border-purple-500/30 group">
                <p className="text-3xl sm:text-4xl font-black text-white mb-2 group-hover:text-purple-400 ">10k+</p>
              ...
              <div className="space-y-20">
                {milestones.map((ms, i) => (
                  ...
                  >
                    ...
                    <div className="relative z-10 w-14 h-14 bg-black border-4 border-blue-500 rounded-full flex items-center justify-center font-black text-sm text-white shrink-0 order-1 md:order-2 ">
                       {i + 1}
                    </div>
