    ...
    <AuthLayout title="Welcome back" subtitle="Sign in to your ChatWizs account">
      ...
      >
        ...
        <div className="space-y-2">
          ...
          <div className="relative group">
            ...
            <input
              ...
              className="w-full bg-white/5 border border-white/10 rounded-2xl py-3.5 sm:py-4 pl-12 pr-4 text-white text-base placeholder:text-gray-600 focus:outline-none focus:ring-1 focus:ring-blue-500/50 focus:border-blue-500/50 "
            />
          </div>
        </div>
        ...
        <div className="space-y-2">
          ...
          <div className="relative group">
            <Lock className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-500 group-focus-within:text-blue-400 " />
            <input
              required
              ...
              placeholder="••••••••"
              className="w-full bg-white/5 border border-white/10 rounded-2xl py-3.5 sm:py-4 pl-12 pr-12 text-white text-base placeholder:text-gray-600 focus:outline-none focus:ring-1 focus:ring-blue-500/50 focus:border-blue-500/50 "
            />
            <button
              type="button"
        ...
        <Button
          type="submit"
          disabled={loading}
          className="w-full bg-white text-black hover:bg-gray-100 h-14 sm:h-16 rounded-2xl font-black text-lg active:scale-[0.98] mt-2 group"
        >
          {loading ? <Loader2 className="w-6 h-6 " /> : (
            <span className="flex items-center gap-2">
              Sign In <ArrowRight className="w-5 h-5 group- transition-transform" />
            </span>
          )}
        </Button>
      </motion.form>
      ...
      <div className="mt-8">
        <button
          ...
          disabled={loading}
          className="w-full bg-[#1877F2] hover:bg-[#166fe5] text-white h-14 sm:h-16 rounded-2xl font-black flex items-center justify-center gap-3 active:scale-[0.98]"
        >
