    ...
    >
      {!success ? (
        <form onSubmit={handleReset} className="space-y-6">
          <div className="flex p-1.5 bg-white/5 border border-white/10 rounded-2xl mb-2">
            <button
              ...
              className={`flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl text-xs font-bold transition-all ${method === 'email' ? 'bg-white text-black shadow-lg' : 'text-gray-500 hover:text-white'}`}
            >
            ...
            <button
              ...
              className={`flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl text-xs font-bold transition-all ${method === 'phone' ? 'bg-white text-black shadow-lg' : 'text-gray-500 hover:text-white'}`}
            >
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full bg-white/5 border border-white/10 rounded-2xl py-3.5 pl-12 pr-4 text-white placeholder:text-gray-600 focus:outline-none focus:ring-1 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all"
                  />
                </div>
              </div>
            ) : (
          ...
          <Button 
            type="submit" 
            disabled={loading}
            className="w-full bg-white text-black hover:bg-gray-100 h-14 rounded-2xl font-black text-lg transition-all active:scale-[0.98] group shadow-[0_8px_20px_rgba(255,255,255,0.1)]"
          >
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 text-gray-500 hover:text-white transition-colors font-bold text-sm"
          >
        ...
        <div className="space-y-8">
           ...
           <Button 
              onClick={onBackToLogin}
              className="w-full bg-white/5 border border-white/10 text-white hover:bg-white/10 h-14 rounded-2xl font-black text-lg transition-all active:scale-[0.98]"
           >
              Return to Login
           </Button>
        </div>
