      ...
      >
        ...
        <div className="space-y-2">
          ...
          <div className="relative group">
            <User className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-500 group-focus-within:text-blue-400 " />
            <input
              required
              type="text"
              value={name}
        ...
        <Button 
          type="submit" 
          disabled={loading}
          className="w-full bg-white text-black hover:bg-gray-100 h-14 sm:h-16 rounded-2xl font-black text-lg active:scale-[0.98] group mt-2 sm:mt-4"
        >
          {loading ? <Loader2 className="w-6 h-6 " /> : (
            <span className="flex items-center gap-2">
              Create Account <ArrowRight className="w-5 h-5 group- transition-transform" />
            </span>
          )}
        </Button>
      </motion.form>
