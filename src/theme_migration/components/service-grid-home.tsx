        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {SERVICES.map((service, index) => (
            <motion.div
              ...
              className="group relative bg-slate-900/20 backdrop-blur-sm border border-white/5 rounded-3xl p-8 hover:border-indigo-500/30 cursor-pointer overflow-hidden"
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-xl font-bold text-white mb-3 group-hover:text-indigo-400 tracking-tight">
                  {service.title}
                </h3>
                ...
                <div className="flex items-center text-xs font-black text-indigo-400 uppercase tracking-[0.2em] group-hover:gap-2 ">
