          ...
          <div className="col-span-2 lg:col-span-2 space-y-8">
            ...
            <div className="flex gap-4">
              {[
                ...
                <a key={i} href={url} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:text-white hover:bg-white/10 hover:border-white/20 group">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="space-y-4">
              ...
              >
                ...
                />
                <button className="absolute right-2 top-2 bottom-2 bg-white text-black px-4 rounded-lg font-bold text-[10px] uppercase hover:bg-gray-100 " type="submit">
                  Join
                </button>
              </form>
            </div>
