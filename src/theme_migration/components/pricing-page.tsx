    ...
    <div className="relative pt-36 pb-24 font-sans">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="relative rounded-[2.5rem] md:rounded-[4rem] overflow-hidden bg-white text-black p-6 md:p-16 lg:p-24 shadow-[0_50px_100px_rgba(0,0,0,0.1)]"
        >
          {/* Decorative Elements */}
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              ...
              <button onClick={() => onNavigate?.('contact')} className="bg-white border-2 border-black/10 text-black px-8 md:px-12 py-4 md:py-5 rounded-2xl font-black uppercase tracking-widest text-xs md:text-sm hover:bg-black/5 transition-colors">
                Speak to Sales
              </button>
            </div>
          </div>
