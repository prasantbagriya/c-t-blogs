...
import { Image } from "@/src/theme_migration/components/ui/shim"
import { ArrowRight, Star, Quote } from "lucide-react"
import GlowButton from "./glow-button"
import SectionHeader from "./section-header"
import { SUCCESS_STORIES } from "../lib/constants"

export default function SuccessStories({ isPage = false }: { isPage?: boolean }) {
  return (
    <section className="py-32 bg-black relative">
      <div className="max-w-7xl mx-auto px-4">
        <SectionHeader 
          ...
          description="Real results for real businesses. See how we've helped our clients achieve remarkable growth."
        />
