...
style.innerHTML = `
    ...
    @media screen and (max-width: 480px) {
        .cw-widget-container { bottom: max(15px, env(safe-area-inset-bottom)) !important; right: 15px !important; gap: 8px !important; }
        .cw-widget-container.bottom-left { left: 15px !important; right: auto !important; }
        .cw-bubble { width: 56px !important; height: 56px !important; min-width: 56px !important; min-height: 56px !important; }
        .cw-window {
            width: calc(100vw - 30px) !important; height: calc(100vh - 120px) !important;
            max-height: 85% !important; bottom: 0 !important; right: 0 !important;
