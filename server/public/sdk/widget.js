...
const initWidget = () => {
    ...
    function applySettings() {
        ...
        styleTag.innerHTML = `
            .cw-msg.user { background: ${s.primaryColor || 'var(--cw-primary)'} !important; }
            .cw-send-btn { background: ${s.primaryColor || 'var(--cw-primary)'} !important; color: ${s.iconColor || '#ffffff'} !important; }
